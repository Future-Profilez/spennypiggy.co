        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Platform Risk Alert: <span style="color:#8C52FF;">{{ $state }}</span>
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    The automated <strong style="color:#8C52FF;">Risk Engine</strong> has detected anomaly metrics and updated the platform state.
                </td>
            </tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    <tr>
                                        <td style="font-family:'Outfit',Arial,sans-serif;font-size:13px;color:#999999;font-weight:500;padding:0 0 10px 0;">
                                            ⚠️ Reasons
                                        </td>
                                    </tr>
                                    @if(count($reasons) > 0)
                                        @foreach($reasons as $reason)
                                            <tr>
                                                <td style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#1A1A1A;font-weight:600;line-height:20px;padding:0 0 6px 0;">
                                                    → {{ $reason }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#666666;font-weight:400;line-height:20px;">
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    <tr>
                                        <td colspan="2" style="font-family:'Outfit',Arial,sans-serif;font-size:13px;color:#999999;font-weight:500;padding:0 0 10px 0;">
                                            📊 Trigger Metrics
                                        </td>
                                    </tr>
                                    @if(count($metrics) > 0)
