        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Regarding your task <strong style="color:#8C52FF;">{{ $task->title }}</strong>
                </td>
            </tr>
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    ...
                                    <tr>
                                        <td style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#1A1A1A;font-weight:600;line-height:21px;padding:0;">
                                            @if($role === 'creator')
                                                @if($resolution === 'creator_won')
                                                    Good news! The dispute has been resolved in your favor. The funds will be released to your account shortly.
                                                @else
                                                     The dispute has been resolved in favor of the supporter. The funds have been refunded.
                                                @endif
                                            @else
                                                 @if($resolution === 'supporter_won')
                                                    Good news! The dispute has been resolved in your favor. A refund has been processed.
                                                @else
                                                     The dispute has been resolved in favor of the creator. The order is now marked as complete.
                                                @endif
                                            @endif
                                        </td>
                                    </tr>
