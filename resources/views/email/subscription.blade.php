...
@section('content')
@php
    $subscriberName = $sub->anonymous == 1 ? 'Someone' : ucwords($sub->user->name);
@endphp
<tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    <strong style="color:#1A1A1A;">{{ $subscriberName }}</strong> subscribed to your wish
            ...
            <tr>
                <td align="center"
                    ...
                    Visit <a href="{{ env('APP_URL') . '/history' }}" style="color:#FF007F;text-decoration:none;font-weight:600;">Spenny Piggy</a> to manage your subscriptions and send a thank you message. ✨
                </td>
            </tr>
