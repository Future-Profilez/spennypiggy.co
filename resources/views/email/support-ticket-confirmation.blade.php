        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Your {{ $ticket->type === 'refund' ? 'refund request' : 'support message' }} has been successfully sent to the creator. They have been asked to respond within <strong style="color:#8C52FF;">48 hours</strong>.
                </td>
            </tr>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#1A1A1A;font-weight:700;padding:8px 0 4px 0;">
                                            {{ str_replace('_', ' ', strtoupper($ticket->event_type ?? 'support')) }}
                                        </td>
                                    </tr>
                                </table>
