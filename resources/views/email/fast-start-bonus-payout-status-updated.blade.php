        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Fast Start Bonus Paid, <span style="color:#8C52FF;">{{ ucwords($creator->name) }}</span>
                </td>
            </tr>
            {{-- Subline --}}
            <tr>
                <td align="center"
                    ...
                    Your <strong style="color:#8C52FF;">Fast Start Bonus</strong> has landed in your Stripe account. Congratulations on a brilliant first 30 days! 🎉
                </td>
            </tr>
            @else
            {{-- Heading --}}
            <tr>
                <td align="center"
                    style="font-family:'Outfit',Arial,sans-serif;font-weight:800;font-size:22px;color:#1A1A1A;
                           line-height:30px;padding:0 0 10px 0;text-align:center;">
                    Fast Start Bonus update, <span style="color:#8C52FF;">{{ ucwords($creator->name) }}</span>
                </td>
            </tr>
            {{-- Subline --}}
            <tr>
                <td align="center"
                    style="font-family:'Outfit',Arial,sans-serif;font-weight:400;font-size:15px;color:#666666;
                           line-height:22px;padding:0 0 24px 0;text-align:center;">
                    There's an update on your <strong style="color:#8C52FF;">Fast Start Bonus</strong> payout.
                    @if(!empty($failureMessage))
                        <br><br>Reason: {{ $failureMessage }}
                    @endif
                </td>
            </tr>
            @endif
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    ...
                                    @if(!empty($arrivalDate) && $status === 'paid')
                                    <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" align="center">
                        <tr>
                            <td align="center" bgcolor="#FF007F"
                                ...
                                <a href="{{ config('app.url') }}/financial/fast-start-bonus"
