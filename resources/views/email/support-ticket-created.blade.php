        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    You have a new {{ $ticket->type === 'refund' ? 'refund request' : 'support message' }} from <strong style="color:#1A1A1A;">{{ $ticket->supporter ? $ticket->supporter->name : ($ticket->guest_email ?: 'a supporter') }}</strong>. Please respond within <strong style="color:#8C52FF;">48 hours</strong> to avoid escalation.
                </td>
            </tr>
