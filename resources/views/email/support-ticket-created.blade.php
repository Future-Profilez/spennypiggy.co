        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 400px; width: 100%; text-align: center;">
            <tr>
                <td style="font-family: Arial, sans-serif; font-weight: bold; font-size: 24px; color:#000; line-height: 32px; padding: 0 0 18px 0; text-align: center;">
                    New Support <span style="color:#8C52FF">Request</span>
                </td>
            </tr>
            <tr>
                <td style="padding: 0 0 22px 0; font-family: Arial; font-weight: normal; font-size: 14px; line-height: 22px; color: #4D4D4D; text-align: center;">
                    You have a new {{ $ticket->type === 'refund' ? 'refund request' : 'support message' }} from {{ $ticket->supporter ? $ticket->supporter->name : ($ticket->guest_email ?: 'a supporter') }}. Please respond within 48 hours to avoid escalation.
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding:0 0 10px 0; text-align: center;">
                    <a href="{{ env('APP_URL') . '/creator/disputes' }}" style="display:inline-block; border-radius:30px;padding:13px 30px;text-decoration:none;border:3px solid #000;background-color:#FF007F;font-family: Arial;font-weight:bold;font-size: 15px;text-align:center;color:#ffffff;cursor:pointer;">View Request</a>
                </td>
            </tr>
        </table>
    </td>
