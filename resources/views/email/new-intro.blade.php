                ...
                <tr>
                    <td style="padding:0 0 10px 0; text-align: center;">
                        <a href="https://admin.spennypiggy.co/intro-videos/"
                            style="border-radius:30px;padding:13px 30px 13px 30px; width: 210px; text-decoration:none; border:none;background-color: #F94F97; font-family: Arial; font-weight: bold; font-size: 15px; text-align: center; color:#ffffff; cursor: pointer;">See Video</a>
                    </td>
                </tr>
            </table>
        </td>
