...
@section('content')
@php
    $subscriberName = $mem->anonymous == 1 ? 'Someone' : ucwords($mem->user->name);
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    <strong style="color:#1A1A1A;">{{ $subscriberName }}</strong> subscribed to your
                    <strong style="color:#8C52FF;">{{ $levelName }}</strong> Membership on Spenny Piggy 🐷
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    Say thanks by <a href="{{ env('APP_URL') . '/' . $mem->user->username }}" style="color:#FF007F;text-decoration:none;font-weight:600;">sending them a message</a>, or manage your memberships anytime. ✨
                </td>
            </tr>
