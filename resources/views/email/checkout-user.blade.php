   ...
   <tr>
      <td align="center" style="padding:10px 10px 20px 10px;">
         <table width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 296px; width: 100%; text-align: center;">
            <tr>
               <td style="font-family: Arial; font-weight: bold; font-size: 18px; color:#000; line-height: 26px; padding: 0 0 25px 0; text-align: center;">Thank you for<span style="color: #8C52FF">granting a wish</span>  on <br> Spenny Piggy 🎁 </td>
            </tr>
            ...
            <tr>
               <td style="padding: 0 0 15px 0; font-family: Arial; font-weight: bold; font-size: 13px; color: 141414; text-align: left; line-height: 18px; text-align: center;">You have granted a wish of <span style="color:#F94F97 "></span> 🤩</td>
            </tr>
