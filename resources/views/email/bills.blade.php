...
@section('content')
@php
    $subscriberName = $bill_pay->anonymous == 1 ? 'Someone' : ucwords($bill_pay->user->name);
    $billName = ucwords(str_replace('_', ' ', $bill_pay->bill->name));
@endphp
<tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    <strong style="color:#1A1A1A;">{{ $subscriberName }}</strong> just subscribed to your
                    <strong style="color:#8C52FF;">{{ $billName }}</strong> bill on Spenny Piggy 🐷
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    Manage your active Bill subscriptions anytime from your account. ✨
                </td>
            </tr>
