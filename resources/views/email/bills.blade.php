...
@section('content')
{{ \Log::info("come in email templates") }}
<tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 296px; width: 100%; text-align: center;">
            <tr>
                <td style="font-family: Arial; font-weight: bold; font-size: 18px; color:#000; line-height: 26px; padding: 0 0 25px 0; text-align: center;">
                    {{ $bill_pay->anonymous == 1 ? 'Someone' : $bill_pay->user->name }} subscribed to your
                    <span style="color: #8C52FF"> {{ ucwords(str_replace('_',' ',$bill_pay->bill->name)) }} </span> Bill.
                </td>
            </tr>

            <tr>
                <td style="padding: 0 0 20px 0; font-family: Arial; font-weight: normal; font-size: 14px; color: #4D4D4D; text-align: center; line-height: 18px;">
