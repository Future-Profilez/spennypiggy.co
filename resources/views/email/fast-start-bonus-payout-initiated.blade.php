        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Fast Start Bonus on the way, <span style="color:#8C52FF;">{{ ucwords($creator->name) }}</span>
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    Your <strong style="color:#8C52FF;">Fast Start Bonus</strong> has been initiated and is being processed by Stripe. Well done on a strong start! 🚀
                </td>
            </tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                ...
                                @if($earningsAmount > 0 || !empty($arrivalDate))
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    @if($earningsAmount > 0)
                                    <tr>
                                        ...
                                        <td align="right" style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#1A1A1A;font-weight:700;padding:0 0 4px 0;">
                                            {{ strtoupper($currency) }} {{ number_format((float) $earningsAmount, 2) }}
                                        </td>
                                    </tr>
                                    @endif
            ...
            <tr>
                <td align="center"
                    ...
                    You can track this payout in your Fast Start Bonus page. If it fails, we'll notify you immediately. ✨
                </td>
            </tr>
