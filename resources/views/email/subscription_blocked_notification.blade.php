        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; width: 100%;" class="subscription-blocked-content">
            ...
            <tr>
                <td style="font-size: 14px; color: #64748b; padding: 0 0 20px 0; line-height: 20px; text-align: center;">
                    Someone just tried to pay you @if($paymentAmount)<strong style="color: #FF007F;">£{{ number_format($paymentAmount, 2) }}</strong>@endif, but the payment couldn't be completed because your creator subscription is not active.
                </td>
            </tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            ...
                            <td style="text-align: right; vertical-align: middle;">
                                <a href="{{ env('APP_URL') . '/subscription/manage' }}" style="background: #FF007F; color: white; padding: 8px 16px; border-radius: 20px; text-decoration: none; font-size: 14px; font-weight: 600;">Update Now</a>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td style="background-color: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 12px; margin: 8px 0;">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            ...
                            <td style="text-align: right; vertical-align: middle;">
                                <a href="{{ env('APP_URL') . '/subscription/manage' }}" style="background: #FF007F; color: white; padding: 8px 16px; border-radius: 20px; text-decoration: none; font-size: 14px; font-weight: 600;">Reactivate</a>
                            </td>
                        </tr>
                    </table>
                </td>
