                                    ...
                                    <tr>
                                        <td style="width:48px;max-width:48px">
                                            <span style="display:block;text-align:center;width:48px;height:48px;border-radius:2px;border:1px solid #e5e5e5">
                                                <img style="min-width:20px;height:20px;padding-top:13px;padding-left:2px" src="https://ci3.googleusercontent.com/meips/ADKq_NayzxuR3j0qbRPNtSEJbwMaNcC0milvvW2DMZAahdAN4XoKXFcu9YqxkRwoaRusR-RhMle5Ab4TRDzGQ1zn8WW4KNzQZYwpXbzdYkOVRXc7S86K7GKpGMXie-FceGPw=s0-d-e1-ft#https://cdn.buymeacoffee.com/assets/img/email-template/new/attachment.png" class="CToWUd" data-bit="iit">
                                            </span>
                                        </td>
