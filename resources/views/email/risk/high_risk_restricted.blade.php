        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    We have detected unusual activity on your account, specifically a high rate of disputes
                    (<strong style="color:#8C52FF;">{{ number_format($metric->dispute_rate_30d * 100, 1) }}%</strong>).
                </td>
            </tr>
                            ...
                            <td style="padding:20px 22px;">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    <tr>
                                        ...
                                        <td align="right" style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#c53030;font-weight:700;padding:0 0 4px 0;">
                                            High Risk
                                        </td>
                                    </tr>
                                    <tr>
