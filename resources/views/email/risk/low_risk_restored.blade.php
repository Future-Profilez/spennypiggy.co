        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Good news, <strong style="color:#1A1A1A;">{{ ucwords($user->name) }}</strong>!
                </td>
            </tr>
            <tr>
                <td align="center"
                    ...
                    Your account metrics have improved and are now within <strong style="color:#8C52FF;">normal ranges</strong>.
                </td>
            </tr>
