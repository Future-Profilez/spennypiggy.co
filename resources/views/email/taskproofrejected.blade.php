        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Attention needed. <strong style="color:#1A1A1A;">{{ ucwords($supporter->name) }}</strong> has rejected your proof for the task
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tr>
                            <td style="padding:18px 20px;font-family:'Outfit',Arial,sans-serif;font-size:14px;line-height:21px;color:#1A1A1A;text-align:left;">
                                <span style="font-family:'Outfit',Arial,sans-serif;font-size:13px;color:#c53030;font-weight:700;">⚠️ Reason</span><br>
