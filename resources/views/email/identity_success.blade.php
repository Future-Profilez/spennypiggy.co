        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Hello <strong style="color:#1A1A1A;">{{ ucfirst(strtolower($user->name)) }}</strong>, congratulations 🙌
                </td>
            </tr>
            <tr>
                <td align="center"
                    ...
                    Your verification was <strong style="color:#8C52FF;">successfully completed</strong>. We will now complete our final check to match your ID image to your uploaded profile picture and social media accounts.
                </td>
            </tr>
