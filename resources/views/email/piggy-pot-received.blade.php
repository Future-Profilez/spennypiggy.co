        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    You Received a Piggy Pot Contribution!
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    <strong style="color:#1A1A1A;">{{ ($pay->is_anonymous ?? false) ? 'Anonymous' : ($pay->user?->name ?? ($pay->guest_name ?? 'A supporter')) }}</strong> contributed to your Piggy Pot 🎉
                </td>
            </tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tr>
                            <td style="padding:20px 22px;">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    <tr>
                                        ...
                                        <td align="right" style="font-family:'Outfit',Arial,sans-serif;font-size:24px;color:#FF007F;font-weight:800;padding:12px 0 0 0;">
                                            {{ $symbol }}{{ number_format((float) ($pay->amount ?? 0), 2) }}
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                    <tr>
                                        <td height="1" bgcolor="#FFD6E8" style="height:1px;line-height:1px;font-size:1px;background-color:#FFD6E8;padding:0;margin-top:12px;">&nbsp;</td>
                                    </tr>
                                </table>
                                <div style="font-family:'Outfit',Arial,sans-serif;font-size:13px;color:#999999;font-weight:500;padding:12px 0 6px 0;">💬 Message</div>
                                <div style="font-family:'Outfit',Arial,sans-serif;font-size:14px;color:#1A1A1A;font-weight:700;line-height:20px;">{{ $pay->message }}</div>
                                @endif
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" align="center">
                        <tr>
                            <td align="center" bgcolor="#FF007F"
                                ...
                                <a href="{{ env('APP_URL') . '/' . ($pay->creator?->username ?? '') . '/piggy-pots' }}"
