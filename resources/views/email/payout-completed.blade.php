        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width:440px;width:100%;">
            ...
            <tr>
                <td align="center" style="padding:0 0 18px 0;">
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" align="center">
                        <tr>
                            <td align="center" valign="middle" bgcolor="{{ $paid ? '#E6F7EC' : '#FDECEC' }}"
                                style="width:68px;height:68px;background-color:{{ $paid ? '#E6F7EC' : '#FDECEC' }};border-radius:50%;
            ...
            <tr>
                <td align="center"
                    ...
                    @if ($paid)
                        Hi {{ ucwords($creator->name) }}, your bank has confirmed the payout below.
                    @else
                        Hi {{ ucwords($creator->name) }}, your bank couldn't accept this payout. The amount has
                        been returned to your balance and will be retried in the next payout run — you don't
                        need to do anything unless your bank details have changed.
                    @endif
                </td>
            </tr>
            ...
            <tr>
                <td align="center" style="padding:0 0 20px 0;">
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%"
                           style="background-color:{{ $paid ? '#F1FAF4' : '#FEF6F6' }};border-radius:14px;">
                        <tr>
            ...
            <tr>
                <td style="padding:0 0 24px 0;">
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%"
                        ...
                        @if ($paid && $arrivalDate)
                        <tr>
                            <td style="padding:8px 0;border-bottom:1px solid #EEEEEE;color:#7A7A7A;">Arrived</td>
                        ...
                        @if ($reference)
                        <tr>
                            <td style="padding:8px 0;border-bottom:1px solid #EEEEEE;color:#7A7A7A;">Reference</td>
                            <td align="right" style="padding:8px 0;border-bottom:1px solid #EEEEEE;color:#1A1A1A;font-weight:600;">
                                {{ $reference }}
                            </td>
                        </tr>
                        @endif
                        @if (! $paid && $failureMessage)
                        <tr>
                            <td style="padding:8px 0;color:#7A7A7A;">Reason</td>
