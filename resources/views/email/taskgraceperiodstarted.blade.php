        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Your task <strong style="color:#8C52FF;">{{ $data['title'] }}</strong> has passed its original
                    deadline. You've entered a <strong style="color:#1A1A1A;">1-hour grace period</strong>.
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    Please submit your work immediately. If not completed in time, the order will be cancelled and refunded automatically. ✨
                </td>
            </tr>
