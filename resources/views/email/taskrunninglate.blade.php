        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 440px; width: 100%;">
            ...
            <tr>
                <td align="center"
                    ...
                    Your task <strong style="color:#8C52FF;">{{ $data['title'] }}</strong> is running a bit late.
                    We've given the creator a grace period to complete it.
                </td>
            </tr>
            ...
            <tr>
                <td align="center"
                    ...
                    If not completed within the grace period, you'll be automatically refunded. ✨
                </td>
            </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" align="center">
                        <tr>
                            <td align="center" bgcolor="#FF007F"
                                ...
                                <a href="{{ env('APP_URL') . '/task/purchases' }}"
