...
<head>
    ...
    <link rel="mask-icon" href={{ url('/favicon.ico') }} />
    ...
    <meta name="msapplication-TileImage" content={{ url('/site.png') }}  >
    ...
    <meta property="og:image" content={{ url('/site.png') }} />
