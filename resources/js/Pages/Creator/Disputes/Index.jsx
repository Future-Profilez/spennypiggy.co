...
export default function DisputesIndex({ auth, disputes, tickets }) {
    const { props } = usePage();
                ...
                <div className="containerbox">
                    ...
                    <div className="flex flex-wrap gap-3 mb-8">
                        <button
                            ...
                            className={`px-5 py-2 rounded-[20px] text-sm font-black uppercase tracking-widest border-[3px] border-black transition-all ${
                                activeTab === 'disputes'
                        ...
                        {activeTab === 'disputes' ? (
                            ...
                            (tickets?.data || []).length === 0 ? (
                                <div className="text-center py-16 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-gray-400 max-w-md mx-auto">You have no pending refund or contact requests.</p>
                                </div>
                            ) : (
                                <div className="overflow-x-auto">
                                    <table className="w-full whitespace-nowrap">
