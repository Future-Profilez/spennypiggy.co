...
export default function Certificate({ profile, user, metrics }) {
    ...
    return (
        <div className="min-h-dvh bg-gray-50 text-slate-800 p-4 md:p-8 font-serif print:p-0 print:bg-white flex flex-col items-center justify-center">
            ...
            <div className="bg-[#fffdf5] w-full max-w-4xl aspect-[1.414/1] shadow-[4px_4px_0px_0px_#FF007F]xl shadow-slate-900/20 relative print:shadow-none print:w-full print:h-dvh print:m-0 overflow-hidden text-slate-900 print-content border-8 border-double border-slate-900">
