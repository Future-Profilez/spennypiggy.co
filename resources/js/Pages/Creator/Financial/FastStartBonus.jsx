...
export default function FastStartBonus({ auth, fast_start_bonus }) {
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="bg-[#A2E4B8] min-h-dvh pb-16">
                <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-5">
                    ...
                    {/* Header */}
 <div className="flex items-center gap-4 bg-white p-5 border-[3px] border-black rounded-box relative overflow-hidden">
 ...
 className="relative z-10 p-3 rounded-box-sm bg-white border-[2px] border-black hover:bg-yellow-300 text-black hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all shrink-0"
                        >
                    ...
                    {!bonus ? (
                        /* Not connected */
 <div className="bg-white border-[3px] border-black rounded-box p-8 text-center">
                        ...
                        <>
                            {/* Hero bonus card */}
 <div className="bg-white border-[3px] border-black rounded-box overflow-hidden">
                                {/* Gradient top strip */}
                                <div className="bg-gradient-to-r from-[#8C52FF] to-[#FF007F] p-6 md:p-8">
                                    <div className="flex items-start justify-between gap-3 mb-4">
 <span className="text-[12px] font-black uppercase tracking-[0.18em] text-white/80">
                                            Platform Bonus
                                        </span>
 <span className={`shrink-0 px-3 py-1 rounded-full text-[12px] font-black uppercase tracking-widest border-2 ${statusInfo.bg} ${statusInfo.border} ${statusInfo.text} `}>
                                            {statusInfo.label}
                                        </span>
                                    </div>
 ...
 <div className="flex justify-between text-[12px] font-black uppercase tracking-widest text-white/70 mb-2">
 ...
 <div className="text-[12px] font-black uppercase tracking-widest text-black/60 mb-1">Window Opened</div>
                                        <div className="text-sm font-black text-black">{formatDate(bonus.window_start)}</div>
                                    </div>
                                    <div className="px-6 py-4">
 <div className="text-[12px] font-black uppercase tracking-widest text-black/60 mb-1">Window Closed</div>
 ...
 <div className="bg-white border-[3px] border-black rounded-box p-6">
                                    ...
                                    <div className="space-y-2.5">
                                        {bonus.tiers.map((tier, idx) => (
                                            <div
                                                key={idx}
 className={`flex items-center justify-between rounded-box-sm px-5 py-3.5 border-2 transition-all ${
                                                    tier.active
 ? 'border-black bg-gradient-to-r from-purple-100 to-pink-100 '
                                                        : tier.reached
 ...
 tier.active ? 'text-[#8C52FF]' : tier.reached ? 'text-green-600' : 'text-black/60'
                                                }`}>
                                                    {tier.rate_pct}%
                                                </span>
                                            </div>
 ...
 <p className="text-xs text-black/60 font-medium mt-4">
 ...
 <dd className="font-mono text-xs text-gray-700 bg-gray-100 px-2 py-1 rounded-box-sm border border-gray-200 truncate max-w-[180px]">
                                                    {bonus.stripe_transfer_id}
                                                </dd>
                                            </div>
                                        )}
                            ...
                            {/* Failed alert */}
                            {bonus.status === 'failed' && (
 <div className="bg-red-100 border-[3px] border-red-500 rounded-box p-6 flex gap-4">
 ...
 <div className="bg-orange-100 border-[3px] border-orange-400 rounded-box p-6 flex gap-4">
 ...
 <span className="shrink-0 w-9 h-9 bg-[#FF007F] border-2 border-black rounded-box-sm flex items-center justify-center text-[12px] font-black text-black ">
                                                {step}
                                            </span>
 ...
 className="text-xs font-black text-black/60 hover:text-black underline underline-offset-2 transition-colors uppercase tracking-widest"
                                >
                                    Terms &amp; Conditions
                                </Link>
                            </div>
