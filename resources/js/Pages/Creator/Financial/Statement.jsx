    ...
    return (
        <div className="min-h-dvh bg-gray-50 text-[#0F172A] p-4 md:p-8 font-sans print:p-0 print:bg-white">
            ...
            <div className="max-w-4xl mx-auto mb-6 flex justify-between items-center print:hidden">
                ...
                <button 
                    onClick={handlePrint}
                    className="flex items-center gap-2 bg-[#0F172A] text-white px-6 py-2 rounded-full font-bold hover:bg-slate-800 transition text-sm"
                >
                    <Printer size={16} />
                    Print / Save PDF
                </button>
            ...
            {/* Document Container */}
            <div className="max-w-4xl mx-auto bg-white rounded-box-sm p-8 md:p-12 print:max-w-none print:w-full print:rounded-none print-container relative overflow-hidden">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="align-middle">
                                                ...
                                                <p className="text-[12px] text-slate-400 font-bold uppercase tracking-widest m-0 mt-1">Official Financial Record</p>
                                            </td>
                                            <td className="align-middle text-right">
                                                <div className="inline-flex flex-col items-end gap-1">
                                                    <div className="flex items-center gap-1.5 text-slate-400 uppercase tracking-widest text-[12px] font-bold">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="align-top w-1/2 text-right">
                                <h3 className="text-[12px] font-bold text-slate-400 uppercase tracking-widest mb-4 text-right">
                                    Statement Details
                                </h3>
                ...
                <div className="mb-16 break-inside-avoid">
                    <h3 className="text-[12px] font-bold text-slate-400 uppercase tracking-widest text-center mb-6">
                        Earnings Summary
                    </h3>
                    ...
                    <table className="w-full text-sm border-collapse">
                        <thead>
                            <tr className="border-b border-slate-100">
                                <th className="text-left py-3 font-bold text-slate-400 text-[12px] uppercase tracking-wider">Description</th>
                                <th className="text-right py-3 font-bold text-slate-400 text-[12px] uppercase tracking-wider">Amount</th>
                            </tr>
                        </thead>
                ...
                {/* Net Profit Summary */}
                <div className="mb-16 break-inside-avoid">
                    <div className="bg-slate-50 rounded-box  p-10 text-center border border-slate-100">
