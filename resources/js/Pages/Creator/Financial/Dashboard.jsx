...
export default function Dashboard({ auth, summary, tax_estimate, vat_status, tax_year, profile, recent_transactions, analytics, top_supporters }) {
        ...
        <AuthenticatedLayout auth={auth} user={auth.user}>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <div className="flex w-full md:w-auto gap-3">
                            <Link 
                                ...
                                className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#F94F96] hover:bg-[#d83a7c] text-white px-4 py-2.5 rounded-xl md:rounded-[30px] font-medium transition-all shadow-lg shadow-pink-500/20 text-sm md:text-base"
                            >
                                <Plus size={18} />
                            ...
                            <a 
                                ...
                                target="_blank"
                                className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-4 py-2.5 rounded-xl md:rounded-[30px] font-medium transition-all border border-gray-700 text-sm md:text-base"
                            >
                                <Download size={18} />
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 opacity-90 text-sm">
                                    Your rolling 12-month revenue is <strong className="font-mono">{formatCurrency(vat_status.revenue)}</strong>. 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 md:p-6 rounded-2xl md:rounded-[30px] border border-gray-700/50 relative overflow-hidden group hover:border-gray-600 transition-colors shadow-xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-2xl md:text-3xl font-bold text-white mt-2">{formatCurrency(summary.gross_income)}</div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 md:p-6 rounded-2xl md:rounded-[30px] border border-gray-700/50 relative overflow-hidden group hover:border-[#05EFB8]/30 transition-colors shadow-xl">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-2xl md:text-3xl font-bold text-[#05EFB8] mt-2">{formatCurrency(summary.profit)}</div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 md:p-6 rounded-2xl md:rounded-[30px] border border-gray-700/50 relative overflow-hidden group hover:border-red-500/30 transition-colors shadow-xl">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-2xl md:text-3xl font-bold text-red-400 mt-2">{formatCurrency(summary.expenses)}</div>
                        </div>
                    </div>

                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 p-5 md:p-6 rounded-2xl md:rounded-[30px] border border-gray-700/50 relative overflow-hidden group hover:border-yellow-500/30 transition-colors shadow-xl">
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="text-2xl md:text-3xl font-bold text-yellow-400 mt-2">{formatCurrency(tax_estimate)}</div>
                            <div className="mt-2 flex flex-col gap-1">
                                <div className="text-[10px] text-gray-500 bg-yellow-500/10 text-yellow-500 font-bold inline-block px-2 py-1 rounded uppercase w-fit">
                                    Set aside {formatCurrency(tax_estimate/12)}/mo
                                </div>
                                            ...
                                            <tr key={supporter.supporter_id} className="hover:bg-white/5 transition-colors">
                                                <td className="px-6 py-4 text-sm flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-[10px] text-gray-500">@{supporter.supporter.username}</div>
                                                    </div>
                                                </td>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-[#1e1e1e] rounded-[20px] md:rounded-[30px] border border-gray-800 p-6 shadow-xl">
                            ...
                            {isEditingProfile ? (
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-gray-900/50 rounded-[20px] md:rounded-[30px] border border-gray-800 space-y-4">
                                        <div>
                                            <span className="block text-[10px] text-gray-500 uppercase font-bold mb-1">Entity Name</span>
                                            <span className="text-gray-100 font-bold block">{profile?.business_name || auth.user.name}</span>
                                        </div>
                                        <div>
                                            <span className="block text-[10px] text-gray-500 uppercase font-bold mb-1">VAT Status</span>
                        ...
                        <div className="bg-[#1e1e1e] rounded-[20px] md:rounded-[30px] border border-gray-800 p-6 shadow-xl relative overflow-hidden">
                            ...
                            <div className="space-y-4 relative z-10">
                                {/* Income Statement */}
                                <div className="group bg-gray-800/40 hover:bg-gray-800 rounded-xl p-4 border border-gray-700/50 hover:border-gray-600 transition-all">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-1">
                                                <FileText size={12} className="text-[#F94F96]" />
                                                <span className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">For Your Accountant</span>
                                            </div>
                                            <h4 className="text-sm font-bold text-white group-hover:text-[#F94F96] transition-colors">Income Statement</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-1">
                                                ...
                                                <span className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Proof of Income</span>
                                            </div>
                                            <h4 className="text-sm font-bold text-white group-hover:text-[#05EFB8] transition-colors">Verified Certificate</h4>
                                        </div>
                                    </div>
                                    <p className="text-[10px] text-gray-400 mb-3 italic">
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            <div className="flex items-center gap-1.5 mb-1">
                                                ...
                                                <span className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Payout Status</span>
                                            </div>
                                            <h4 className="text-sm font-bold text-white group-hover:text-yellow-400 transition-colors">Transaction History</h4>
                                        </div>
                                    </div>
                                    <p className="text-[10px] text-gray-400 mb-3 italic">
