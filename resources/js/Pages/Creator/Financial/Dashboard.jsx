            ...
            <Modal show={showReserveDetails} onClose={() => setShowReserveDetails(false)} maxWidth="2xl">
                <div className="bg-white text-gray-900 p-5 md:p-6">
                    <div className="flex items-start justify-between gap-4">
                        <div>
                            <div className="text-[15px] font-bold uppercase tracking-widest text-gray-500">Held Reserves</div>
                            <div className="text-xl md:text-2xl font-bold mt-1 text-gray-900">{formatCurrency(reserveTotal, displayCurrency)}</div>
                        ...
                        <button
                            ...
                            className="px-3 py-2 rounded-xl bg-gray-100 border border-gray-200 text-gray-600 hover:text-gray-900 hover:bg-gray-200 transition-colors text-sm font-bold"
                        >
                            Close
                        </button>
                    </div>
                            ...
                            {active_tab === 'payouts' && (
                                <div className="space-y-8 ">
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                                        <div className="bg-white p-5 md:p-6 rounded-[25px] md:rounded-[30px]  border border-gray-200 shadow-sm">
                                            <div className="flex items-center justify-between gap-4">
                                                <div>
                                                    <div className="text-gray-500 text-[15px] font-bold uppercase tracking-wider mb-1">Weekly Payout Window</div>
                                                    <div className="mt-3 text-gray-900 text-lg md:text-xl font-bold">{cycleWindowLabel || '—'}</div>
                                                    <div className="mt-3 text-[15px] text-gray-500 mt-2 font-bold">Next payout: <span className="text-gray-900">{nextPayoutLabel || '—'}</span></div>
                                                    {payout_cycle?.timezone && (
                                                        <div className="text-[13px] text-gray-400 mt-3 font-bold uppercase tracking-widest">{payout_cycle.timezone} timezone</div>
                                                    )}
                                                </div>
                                        ...
                                        <button
                                            ...
                                            className="text-left bg-white p-5 md:p-6 rounded-[25px] md:rounded-[30px]  border border-gray-200 shadow-sm hover:border-purple-500/30 transition-colors relative group"
                                        >
                                            
                                            <div className="flex items-center justify-between gap-4">
                                                <div>
                                                    <div className="text-gray-500 text-[15px] font-bold uppercase tracking-wider mb-1">Reserve Hold</div>
                                            ...
                                            <div className="mt-3 text-center px-2 py-2 rounded-full bg-gray-100 border border-gray-200 text-gray-600 text-[12px] font-bold uppercase tracking-wider group-hover:bg-purple-600 group-hover:text-white transition-all">
                                                View Transactions &gt;
                                            </div>
                                        </button>
                                                    ...
                                                    <div className="flex items-start justify-between gap-4">
                                                        <div className="flex flex-col">
                                                            <div className="flex items-center gap-3">
                                                                <div className="text-gray-500 text-[14px] font-black uppercase tracking-widest">Fast Start Bonus</div>
                                                                <div className="inline-flex items-center gap-2 bg-[#FF007F]/10 text-[#FF007F] border border-[#FF007F]/20 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-widest">
                                                                    Platform Bonus
                                                                </div>
                                                    ...
                                                    {fast_start_bonus.status === 'active' ? (
                                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                            <div className="bg-gray-50 border border-gray-200 rounded-[22px] px-4 py-3">
                                                                <div className="text-[11px] font-black uppercase tracking-widest text-gray-500">Window Ends</div>
                                                                <div className="mt-1 text-[15px] font-bold text-gray-900">{end ? end.toLocaleDateString('en-GB') : '—'}</div>
                                                            </div>
                                                            <div className="bg-gray-50 border border-gray-200 rounded-[22px] px-4 py-3">
                                                                <div className="text-[11px] font-black uppercase tracking-widest text-gray-500">Days Left</div>
                                                                <div className="mt-1 text-[15px] font-bold text-gray-900">{fast_start_bonus.days_remaining ?? '—'}</div>
                                                            </div>
                                                            <div className="bg-gray-50 border border-gray-200 rounded-[22px] px-4 py-3">
                                                                <div className="text-[11px] font-black uppercase tracking-widest text-gray-500">Progress</div>
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
                                        <div className="lg:col-span-2 space-y-8">
                                            ...
                                            {/* Top Supporters */}
                                            <div className="bg-white rounded-[20px] md:rounded-[30px]  border border-gray-200 shadow-sm overflow-hidden">
                                                    ...
                                                    {[
                                                        ...
                                                        return (
                                                            <div key={key} className="bg-gray-50 rounded-[20px] p-3 border border-gray-200">
                                                                <div className="flex items-center justify-between mb-1.5"><div className="flex items-center gap-2"><span className="text-base">{emoji}</span><span className="text-sm font-semibold text-gray-900">{key}</span></div><span className="text-sm font-bold text-gray-900">{formatCurrency(t?.total ?? 0, displayCurrency)}</span></div>
