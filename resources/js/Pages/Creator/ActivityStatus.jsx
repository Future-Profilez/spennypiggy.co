        ...
        return (
            <div className="space-y-4">
                ...
                <div className="relative">
                    <div className="space-y-2 p-4 bg-gray-50 rounded-[30px] md:rounded-[40px]   max-h-96 overflow-y-auto">
                        {timeline.map((day, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Enhanced Tooltip */}
                                    <div className="absolute left-full ml-4 top-1/2 transform -translate-y-1/2 px-3 py-2 bg-gray-900 text-white text-xs rounded-[30px] md:rounded-[40px]   opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
        ...
        <GuestLayout>
            ...
            <div className="container !pt-12 mx-auto px-4 py-8 max-w-6xl">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        <h1 className="text-white font-gulfs uppercase text-4xl  text-gray-900">Activity Status</h1>
                        <p className="text-gray-400 mt-1">Monitor your content activity and payment eligibility</p>
                    </div>
                </div>

                {/* Current Status Card */}
                <div className="bg-white rounded-[30px] md:rounded-[40px]   shadow-lg p-6 mb-8">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            {activityStatus.status === 'grace_period' && (
                                <div className="bg-blue-50 border border-blue-200 rounded-[30px] md:rounded-[40px]   p-4">
                            ...
                            {activityStatus.status === 'insufficient_content' && (
                                <div className="bg-red-50 border border-red-200 rounded-[30px] md:rounded-[40px]   p-4">
                            ...
                            {activityStatus.status === 'grace_period_ending' && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-[30px] md:rounded-[40px]   p-4">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-white rounded-[30px] md:rounded-[40px]   shadow p-6">
                    ...
                    <div className="bg-white rounded-[30px] md:rounded-[40px]   shadow p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button 
                                ...
                                disabled={refreshing}
                                className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 rounded-[30px] md:rounded-[40px]   transition-colors"
                            >
                                {refreshing ? '🔄' : '↻'} Refresh
                            </button>
                        </div>
                            ...
                            {blockedPayments.last_blocked_at && (
                                <div className="space-y-2">
                                    ...
                                    {blockedPayments.recent_attempts && blockedPayments.recent_attempts.length > 0 && (
                                        <div className="bg-gray-50 rounded-[30px] md:rounded-[40px]   p-3">
                        ...
                        {blockedPayments.count > 0 && (
                            <div className="mt-4 p-3 bg-red-50 rounded-[30px] md:rounded-[40px]  ">
                        ...
                        {blockedPayments.count === 0 && (
                            <div className="mt-4 p-3 bg-green-50 rounded-[30px] md:rounded-[40px]  ">
