                        ...
                        {timeline.map((day, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Enhanced Tooltip */}
                                    <div className="absolute left-full ml-4 top-1/2 transform -translate-y-1/2 px-3 py-2 bg-gray-900 text-white text-xs rounded-[30px]   opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
