                        ...
                        {timeline.map((day, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Enhanced Tooltip */}
                                    <div className="absolute left-full ml-4 top-1/2 transform -translate-y-1/2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
                    ...
                    <div className="bg-white rounded-2xl shadow p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button 
                                ...
                                disabled={refreshing}
                                className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 disabled:opacity-50 rounded-lg transition-colors"
                            >
                                {refreshing ? '🔄' : '↻'} Refresh
                            </button>
                        </div>
