                    ...
                    <div className="mx-auto max-w-[900px]">
                        ...
                        <div className="">
                            ...
                            <form onSubmit={submit} className="p-6 md:p-10 space-y-6 bg-white">
                                ...
                                {/* Type Selection */}
                                <div className="">
                                    <label className="block font-black text-normal mb-2 mt-8 capitalize tracking-wide text-start">Delivery Method</label>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <button
                                            type="button"
                                        ...
                                        >
                                            <div className="font-black text-lg uppercase mb-1">⚡ Instant Delivery</div>
                                            <div className={`text-sm font-medium ${data.type === 'instant' ? 'text-pink-100' : 'text-gray-600'}`}>
                                                Content is delivered automatically immediately after payment.
                                            </div>
                                        </button>
                                        ...
                                        >
                                            <div className="font-black text-lg uppercase mb-1">⏳ Timed / Manual</div>
                                            <div className={`text-sm font-medium ${data.type === 'timed' ? 'text-blue-100' : 'text-gray-600'}`}>
                                                You upload proof of completion within a set timeframe.
                                            </div>
                                        </button>
                                    </div>
                                </div>
                                ...
                                {data.type === 'timed' && (
                                    <div className="">
                                        ...
                                        <p className="text-sm text-blue-800 mt-3 font-bold">
                                            You have {data.sla_hours} hours to complete the task after purchase. After {data.sla_hours} hours, the task will be marked as expired.
                                        </p>
                                ...
                                {data.type === 'instant' && (
                                    <div className="">
                                        <div className="border-2 border-black rounded-[20px] p-4 bg-pink-100 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                                            ...
                                            ></textarea>
                                            <p className="text-sm font-black text-gray-900 mb-2 uppercase">OR Upload File</p>
                                            ...
                                            {task.deliverable_content && !data.deliverable_file && (
                                                <div className="mb-4 text-sm text-blue-800 font-bold bg-blue-100 p-3 rounded-lg border-2 border-black flex flex-col gap-2">
                                                    <div className="flex items-center gap-2">
                                                        <span>📁</span> 
                                                        <span>
                                                            Current File: <strong>{task.deliverable_content.split('/').pop()}</strong>
                                                        </span>
                                                    </div>
                                            ...
                                            <GlobalUploader
                                                ...
                                                type="minimal"
                                                sendFile={handleDeliverableUpload}
                                            ...
                                            {data.deliverable_file && (
                                                <div className="mt-3 text-sm text-green-800 font-bold bg-green-100 p-3 rounded-lg border-2 border-black flex items-center gap-2">
                                                    <span>✅</span> New File selected: {data.deliverable_file.name}
                                                </div>
                                            )}
                                        </div>
                                        <InputError message={errors.deliverable_file} className="mt-2 font-bold text-red-600" />
                                    </div>
                                )}
