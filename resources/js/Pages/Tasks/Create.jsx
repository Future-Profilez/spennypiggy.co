                        ...
                        <div className="">
                            ...
                            >
                                    ...
                                    <div className="mb-0">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                step="0.01"
                                                className="relative z-0 w-full border-2 border-black rounded-[40px]  
                                ...
                                {/* <div className="group">
                                    ...
                                    <div className="border-2 border-black rounded-[40px]  p-6 bg-gray-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                                        <GlobalUploader
                                            ctxName="task-cover"
                                            type="minimal"
