            ...
            <div className="wishlistPage bg-white pt-8">
                <div className="containerbox p-3">
                    <div className="max-w-4xl mx-auto md:py-8 text-gray-800">
                        ...
                        <header className="bg-white rounded-[30px] md:rounded-[40px]    shadow-sm">
                            <div className="max-w-6xl mx-auto px-3 py-3 md:px-6 md:py-6 md:flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-[30px] md:rounded-[40px]  bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center text-white font-semibold">
                                        SP
                                    </div>
                                    <div>
                                ...
                                <div className="mt-4 md:mt-0 md:text-right text-sm text-gray-500">
                                    ...
                                    <div className="mt-1 no-print">
                                        <button onClick={print}
                                            className="inline-block px-3 py-1 border rounded-[30px] md:rounded-[40px]  text-sm"
                                        >
                                            Print / Download
                                        </button>
                                    </div>
                        ...
                        <main className="max-w-6xl mx-auto">
                            <section className="accent mt-12 ">
                                ...
                                <div className="mt-6 grid grid-cols-1 md:grid-cols-1 gap-2">
                                    <div className="bg-gray-50 p-3 sm:p-4 rounded-[30px] md:rounded-[40px]  border">
                                ...
                                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6">
                                    <article className="bg-gray-50 p-3 sm:p-4 rounded-[30px] md:rounded-[40px]  border">
                                ...
                                <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-2  lg:gap-4">
                                    <div className="bg-gray-50 p-3 sm:p-4 rounded-[30px] md:rounded-[40px]  border text-sm">
