  ...
  return (
    ...
    <section className='bg-black pb-24 relative overflow-hidden'>
      ...
      <div className="relative ">
        ...
        alt="Wishlist image"
        />
        <p className='uppercase text-center mt-4 text-gray-400 font-poppins text-[10px] xl:text-[15px] tracking-wider'>*3 days Free trial and then requires a monthly £8.99 payment to cover stripe fees and compliance costs. </p>
      </div>
