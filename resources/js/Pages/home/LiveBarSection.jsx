        ...
        <div className='container px-4 w-100' >
          <h2 className='text-2xl md:text-4xl lg:text-5xl font-gulfs text-white text-center mb-12 uppercase leading-none' >
           ...
           <Lightbox classes="m-auto d-table" text={<>
              <div className="videoBg w-100 mt-3 rounded-[40px] border-4 border-pink-500 shadow-[0_0_30px_rgba(236,72,153,0.3)] overflow-hidden group cursor-pointer hover:scale-[1.01] transition-transform duration-300" >
                <div className="relative">
                    <img alt={"image"}  className='w-full h-auto' src={spennys} />
