  ...
  return (
    <section className="bg-transparent relative py-20 md:py-28">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
          ...
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-[#FF007F] rounded-full mix-blend-multiply filter blur-3xl opacity-30 floating-shape" style={{animationDelay: '1s'}}></div>
      </div>
