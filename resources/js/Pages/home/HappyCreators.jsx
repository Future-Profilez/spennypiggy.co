                                ...
                                msg.map((m, i) => (
                                    <SwiperSlide key={`swiper-item-${i}`}>
                                        <div
                                          ...
                                          className="fading min-h-[245px] rounded-[40px]  bg-gray-900 border border-gray-800 p-[25px] shadow-[6px_6px_0_0_#F94F96] hover:translate-y-[-5px] transition-transform duration-300"
                                        >
