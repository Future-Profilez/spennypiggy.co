  ...
  `}</style>
        <div className='lightpink-50 pt-0 pt-sm-3 pt-md-5'>
            ...
            <div className='e8_tag d-flex mt-0 mt-md-5' >
                <div className='8tag w-50 position-relative border-black border-start-0 p-5 text-center d-flex justify-content-center' >
                ...
                <div className='conversion w-50 border-black border-end-0 border-start-0 px-4 px-md-5 py-5 text-center d-flex justify-content-center align-items-center' >
                    <div >
