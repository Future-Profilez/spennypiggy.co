                        ...
                        <div className="row ">
                            ...
                            >
                                <div className="box rounded-md infobox shadow-black-sm mt-4">
                                    ...
                                    <p className="text-dark">
                                        We don’t calll them “Customers” or
                                        transactions. They are your Supporters.
                                    </p>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                <div className="box rounded-md infobox shadow-black-sm mt-4">
                                    ...
                                    <p className="text-dark">
                                        You get to talk to a human for help, or
                                        if you’d just like some advice to hit
                                        the ground running.
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <div className="box rounded-md infobox shadow-black-sm mt-4">
                                    ...
                                    <p className="text-dark">
                                        You get paid instantly to your stripe
                                        balance. No more 30-days delays.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="e8_tag d-flex mt-0 mt-md-5">
                    ...
                    >
                        ...
                        <div className="percent-eight-text">
                            ...
                            <p className="max-width-500 m-auto d-table">
                                From only 8% fees and built in VAT %
                                customisation!
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div>
                            ...
                            <p className="max-width-500 m-auto d-table">
                                Currency conversions will affect some payments,
                                however not applicable to USD - USD payments or
                                GBP - GBP payments. 🥳
                            </p>
                        </div>
                    </div>
