         ...
         <div className="absolute top-1/2 left-0 w-full transform -translate-y-1/2 z-1">
            <LiveBar reps={20} color={`yellowbg`} classes={''} text={"  Coming Soon      "} />
              ...
              <div className='membership-image py-2 px-4 mx-auto flex justify-center max-w-4xl mt-3 relative  ' >
                <div className="rounded-[30px] md:rounded-[40px]  overflow-hidden border-2 border-pink-500/30 shadow-[0_0_50px_rgba(236,72,153,0.3)] ">
                    <LazyLoadImage
                    alt={"image"}
                    effect="blur"
        ...
        <div className="containerbox relative  ">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
            {supportData.map((item, index) => (
              ...
              <div 
                  className="relative w-full max-w-[220px] aspect-[4/3] bg-gray-900 rounded-[30px] md:rounded-[40px]  flex items-center justify-center border-2 transition-all duration-300 overflow-hidden group-hover:shadow-lg"
                  style={{
