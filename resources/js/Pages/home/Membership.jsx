          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto">
            {supportData.map((item, index) => (
              ...
              >
                ...
                <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                  <item.icon size={64} color={item.color} />
                </div>
              </div>

              <h3 className="fading mt-8 mb-2 leading-tight text-xl md:text-2xl uppercase font-gulfs text-white transition-all duration-300 tracking-wide"
