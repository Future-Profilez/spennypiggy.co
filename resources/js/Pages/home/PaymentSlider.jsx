...
export default function PaymentSlider() {
  ...
  return (
    <div className="md:py-6 mb-8">
    <div className="flex items-center justify-center gap-2 mb-6 px-4">
      <span className="text-base" aria-hidden>🔒</span>
      <p className="text-center text-[11px] md:text-xs font-bold uppercase tracking-[0.22em] text-white/55">Secure payments · powered by trusted partners</p>
    </div>
    <div className="overflow-hidden" style={{ WebkitMaskImage: 'linear-gradient(to right, transparent, #000 7%, #000 93%, transparent)', maskImage: 'linear-gradient(to right, transparent, #000 7%, #000 93%, transparent)' }}>
    <Swiper
    ...
    >
        <SwiperSlide className="!w-auto overflow-visible h-full mb-2" >
          <div className={`text-white max-h-[120px] h-[100px] min-w-[120px] md:max-h-[130px] md:h-[130px] md:min-w-[130px] flex justify-center items-center  `}>
            <div className={`bg-white w-full min-h-[70px] flex items-center justify-center px-5 py-1 border-2 border-black rounded-2xl shadow-[3px_3px_0_0_#FF007F]`}>
