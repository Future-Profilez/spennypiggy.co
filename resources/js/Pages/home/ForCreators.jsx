  ...
  return (
    <div className='forcreators pt-3 pt-md-5 bg-white' >
       ...
       <div className='mt-2 mt-sm-5  pt-5' >
            ...
            <p className='max-width-900 text-muted m-auto text-center text-[20px]'  data-aos="zoom-in" >Spenny Piggy makes it super easy to receive financial donations, offer bespoke memberships & publish free and exclusive content!</p>
