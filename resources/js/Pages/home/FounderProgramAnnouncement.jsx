        ...
        <>
            <section className="bg-black py-16 md:py-24 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                    <div className="absolute top-10 right-10 w-96 h-96 bg-yellow-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
                    <div className="absolute bottom-10 left-10 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{animationDelay: '1s'}}></div>
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="flex-1 text-center lg:text-left">
                            <div className="mb-8">
                                <div className="inline-flex items-center bg-gray-900/80 backdrop-blur-sm rounded-full px-6 py-2 mb-6 border border-yellow-400/30 shadow-[0_0_15px_rgba(250,204,21,0.2)]">
                            ...
                            <h2 className="text-2xl md:text-4xl lg:text-5xl font-gulfs text-white mb-6 leading-none uppercase">
                            ...
                            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl leading-relaxed font-poppins">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div className="bg-gray-900 p-4 rounded-2xl border border-pink-500/30 flex items-center space-x-4 shadow-[4px_4px_0_0_#ec4899] hover:translate-y-[-2px] transition-transform duration-300">
                                ...
                                <div className="bg-gray-900 p-4 rounded-2xl border border-pink-500/30 flex items-center space-x-4 shadow-[4px_4px_0_0_#ec4899] hover:translate-y-[-2px] transition-transform duration-300 md:col-span-2">
