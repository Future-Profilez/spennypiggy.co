...
Stay updated with our newest community members.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3 gap-6">
          {creators.map((c) => (
            <Link key={c.id} href={`/${c.username}`} className="fading group relative bg-gray-900 rounded-xl  p-4 border-2 border-green-500 hover:scale-[1.02] transition-all duration-300 shadow-[4px_4px_0_0_#22c55e] hover:shadow-[6px_6px_0_0_#22c55e] text-white">
