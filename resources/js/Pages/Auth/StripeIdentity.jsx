    ...
    return (
        <Authenticated>
            <div className="flex flex-col py-12 items-center justify-center min-h-[80vh] bg-gray-100">
                <div className="rounded-xl  p-6 sm:p-10 max-w-xl w-full">
                    {/* Admin Review Banners */}
                    {/* {auth?.user?.identity_status == 1 && (!adminIdentity || adminIdentity?.status !== 1) && (
                        <div className="mb-4 text-blue-800 bg-blue-100 p-4 rounded-xl  border border-blue-200 text-center">
                    ...
                    {/* {auth?.user?.identity_status === 2 && (
                        <div className="mb-4 text-red-800 bg-red-100 p-4 rounded-xl  border border-red-200 text-center">
                    ...
                    {auth?.user?.identity_verification_error && (
                        <div className="mb-4 text-yellow-700 bg-yellow-100 p-4 rounded-xl  border border-yellow-200 text-center">
