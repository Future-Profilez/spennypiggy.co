...
export default function Register(props) {
    ...
    const getFieldClassName = useCallback(
        (
            field,
            baseClassName = "mt-1 block w-full bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:ring-2 focus:ring-pink-500 focus:border-transparent rounded-[30px] md:rounded-[40px]  p-3"
        ) => {
    ...
    const renderFieldStatusIcon = useCallback(
        (field) => {
            ...
            return (
                <div className="absolute bg-white p-2 right-2 rounded-[30px] md:rounded-[40px]  top-1/2 -translate-y-1/2">
        ...
        <GuestLayout>
            ...
            <div className="min-h-[92vh]  bg-black relative flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
                ...
                <div className="relative z-1 w-full max-w-4xl">
                    ...
                    <div className="md:!bg-gray-900/40 md:!backdrop-blur-xl md:border md:border-white/10 md:rounded-[30px] md:rounded-[40px]   p-0 md:p-1 md:shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                        ...
                        <div className="p-2 md:!p-8 md:bg-black/20 rounded-b-xl">
                                ...
                                <div className="animate-fade-in-up px-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div
                                            ...
                                            className={`cursor-pointer rounded-[30px] md:rounded-[40px]   p-6 border-2 transition-all duration-300 transform hover:-translate-y-2 group ${
                                                role == 1
                            ...
                            {step === 1 && (
                                <div className="animate-fade-in-up text-center px-4">
                                    ...
                                    <button
                                        onClick={handleNext}
                                        className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-anton uppercase tracking-widest text-normal py-[12px] px-8 rounded-[30px] md:rounded-[40px]  shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 transform hover:-translate-y-1 transition-all duration-300   w-fit" >
                                ...
                                <div className="animate-fade-in-up md:px-4">
                                    ...
                                    <div className="flex justify-center">
                                        <button
                                            ...
                                            className={`bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-anton uppercase tracking-widest text-normal py-2 px-12 rounded-[30px] md:rounded-[40px]  shadow-lg shadow-pink-500/30 hover:shadow-pink-500/50 transform hover:-translate-y-1 transition-all duration-300  w-fit disabled:opacity-50 disabled:cursor-not-allowed`}
                                        >
                                            Next
                                        </button>
                                    </div>
                                ...
                                <div className="animate-fade-in-up">
                                    ...
                                    >
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="md:col-span-1">
                                                ...
                                                <select
                                                    ...
                                                    className="mt-1 block w-full bg-white/5 border border-white/10 text-white focus:ring-2 focus:ring-pink-500 focus:border-transparent rounded-[30px] md:rounded-[40px]  p-3"
                                                    value={data.gender}
                                                >
                                        ...
                                        <div
                                            className={`${
                                                mypass ? "block" : "hidden"
                                            } bg-white/5 rounded-[30px] md:rounded-[40px]  p-4 border border-white/10`}
                                        >
                                                        ...
                                                        <div className="relative">
                                                            <Countries
                                                                ...
                                                                selectClassName={getFieldClassName(
                                                                    "country",
                                                                    "w-full bg-white/5 border border-white/10 text-white focus:ring-2 focus:ring-pink-500 focus:border-transparent rounded-[30px] md:rounded-[40px]  p-3"
                                                                )}
                                                            />
                                                            {renderFieldStatusIcon(
                                                                "country"
                                        ...
                                        <div className="pt-4 border-t border-white/10">
                                            ...
                                            <div className="relative flex gap-2">
                                                <input
                                                    ...
                                                    className={`flex-1 bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:ring-2 focus:ring-pink-500 focus:border-transparent rounded-[30px] md:rounded-[40px]  p-3 ${
                                                        hasReferralFromUrl
                                                ...
                                                {!hasReferralFromUrl &&
                                                    (codevalid ? (
                                                        <button
                                                            type="button"
                                                            onClick={removecode}
                                                            className="bg-red-500 hover:bg-red-600 text-white px-4 rounded-[30px] md:rounded-[40px]  font-medium transition-colors"
                                                        >
                                                            Remove
                                                        </button>
                                                    ) : (
                                                        <button
                                                            ...
                                                            className="bg-pink-600 hover:bg-pink-500 text-white px-4 rounded-[30px] md:rounded-[40px]  font-medium transition-colors"
                                                        >
                                                            Apply
                                                        </button>
                                                    ))}
                                            ...
                                            {referralMessage && (
                                                <div
                                                    className={`mt-3 rounded-[30px] md:rounded-[40px]  px-4 py-3 text-sm font-medium border ${
                                                        referralType ===
                                                        "success"
                                        ...
                                        <div className="">
                                            <Popup
                                                action={hasPop}
                                                modalclass="bg-gray-900 border border-white/10 shadow-2xl rounded-[30px] md:rounded-[40px]   p-6 max-w-lg w-full"
                                                space="4"
                                                size="md"
                                                classes={`hidden`}
                                                text={`Create Account`}
                                                ...
                                                <div className="text-white">
                                                    ...
                                                    <LoaderButton
                                                        ...
                                                        className={`
                                                            ...
                                                            w-full justify-center bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-gulfs uppercase tracking-widest text-normal py-3 rounded-[30px] md:rounded-[40px]    `}
