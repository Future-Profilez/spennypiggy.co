            ...
            {showDetails ? (
                <div>
                    ...
                    <div className="flex items-center mb-3">
                        ...
                        <input
                            ...
                            className="flex-1 text-normal border-gray-300 border px-4 py-3 w-full rounded-[40px]  focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 text-gray-900 text-post-content"
                            required
                        />
                    </div>
                ...
                <div className="showHideDetailsCol flex justify-center my-4">
                    <div>
                        ...
                        <button
                            className="cursor-pointer m-auto flex items-center pinkbg text-white p-2 rounded-[40px]  px-3 my-3"
