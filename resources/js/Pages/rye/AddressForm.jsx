                ...
                <div className="flex items-center mb-3">
                    ...
                    <div className="flex-1">
                        <input
                            ...
                            className={`text-normal border-gray-300 border px-4 py-3 w-full rounded-box  focus:outline-none focus:border-[#FF007F] focus:ring-1 focus:ring-pink-500 text-gray-900 ${
