...
export default function Index({ auth, mySubscriptions, subscribersToMe, subscriptionStats }) {
    ...
    const renderSubscriberCard = (subscription) => {
        return (
            <div key={subscription.id} className="bg-white rounded-[40px]   shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 mb-4 border-l-4 border-green-400">
                <div className="lg:flex flex-col md:flex-row">
    ...
    const StatCard = ({ icon, title, value, subtitle, color = "blue" }) => {
        ...
        return (
            <div className={`bg-white rounded-[40px]  shadow-md p-6 border-t-4 ${borderClass}`}>
                    ...
                    <div className="py-8">
                        ...
                        <div className="flex space-x-4 mb-6">
                            <button
                                ...
                                className={`px-6 py-3 rounded-[40px]   font-medium transition-colors ${
                        ...
                        {activeTab === 'my-subscriptions' && (
                            <div>
                                ...
                                {mySubscriptions.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 bg-white rounded-[40px]  ">
                                        ...
                                        <Link
                                            href="/"
                                            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-[40px]  shadow-sm text-white bg-purple-600 hover:bg-purple-700"
                                        >
                                            Browse Creators
                                        </Link>
                                    </div>
                            ...
                            <div>
                                ...
                                {subscribersToMe.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 bg-white rounded-[40px]  ">
                                        ...
                                        <Link
                                            href="/profile"
                                            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-[40px]  shadow-sm text-white bg-green-600 hover:bg-green-700"
                                        >
