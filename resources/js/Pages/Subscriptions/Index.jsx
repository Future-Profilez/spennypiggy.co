...
export default function Index({ auth, mySubscriptions, subscribersToMe, subscriptionStats }) {
    ...
    const renderSubscriptionCard = (subscription) => {
        ...
        return (
            <div key={subscription.id} className="bg-white rounded-[30px] md:rounded-[40px]   shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 mb-4 border-l-4 border-purple-400">
                    ...
                    <div className="relative w-full h-[200px] lg:h-auto lg:max-w-[200px] bg-purple-50 flex items-center justify-center p-4">
                        ...
                        {subscription.wish_item?.image_url ? (
                            <img src={subscription.wish_item.image_url} 
                                ...
                                className="h-12 w-12 object-cover rounded-[30px] md:rounded-[40px] "
                            />
                        ) : (
                            <div className="h-12 w-12 flex items-center justify-center bg-purple-50 rounded-[30px] md:rounded-[40px] ">
                        ...
                        <div className="flex justify-between items-center mt-4">
                            ...
                            {subscription.can_cancel && (
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-red-600 bg-red-50 border border-red-200 rounded-[30px] md:rounded-[40px]  hover:bg-red-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
    ...
    const renderSubscriberCard = (subscription) => {
        return (
            <div key={subscription.id} className="bg-white rounded-[30px] md:rounded-[40px]   shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 mb-4 border-l-4 border-green-400">
                <div className="lg:flex flex-col md:flex-row">
    ...
    const StatCard = ({ icon, title, value, subtitle, color = "blue" }) => {
        ...
        return (
            <div className={`bg-white rounded-[30px] md:rounded-[40px]  shadow-md p-6 border-t-4 ${borderClass}`}>
        ...
        >
                    ...
                    <div className="py-8">
                        ...
                        <div className="flex space-x-4 mb-6">
                            <button
                                ...
                                className={`px-6 py-3 rounded-[30px] md:rounded-[40px]   font-medium transition-colors ${
                        ...
                        {activeTab === 'my-subscriptions' && (
                            <div>
                                ...
                                {mySubscriptions.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 bg-white rounded-[30px] md:rounded-[40px]  ">
                                        ...
                                        <Link
                                            href="/"
                                            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-[30px] md:rounded-[40px]  shadow-sm text-white bg-purple-600 hover:bg-purple-700"
                                        >
                                            Browse Creators
                                        </Link>
                                    </div>
                            ...
                            <div>
                                ...
                                {subscribersToMe.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 bg-white rounded-[30px] md:rounded-[40px]  ">
                                        ...
                                        <Link
                                            href="/profile"
                                            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-[30px] md:rounded-[40px]  shadow-sm text-white bg-green-600 hover:bg-green-700"
                                        >
            ...
            {showToast && (
                <div className={`fixed top-4 right-4 z-50 max-w-sm w-full transform transition-all duration-300 ${
                    ...
                    <div className={`rounded-[30px] md:rounded-[40px]   p-4 shadow-lg ${
                            ...
                            <div className="ml-auto pl-3">
                                <div className="-mx-1.5 -my-1.5">
                                    <button
                                        ...
                                        className="inline-flex rounded-[30px] md:rounded-[40px]  p-1.5 hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2"
                                    >
