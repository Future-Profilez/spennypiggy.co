            ...
            <div className="flex-1 flex flex-col bg-white md:border-[1px] md:border-black md:rounded-[30px]  shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden min-h-0 relative lg:h-full">
              <div className="bg-yellow-300 text-white  border-b-[1px] border-black !border-t-0 !border-l-0 !border-r-0 p-4 flex items-center justify-between gap-3 shrink-0">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-10 h-10 min-w-10 flex items-center justify-center rounded-[30px] border-[3px] border-black bg-white text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all" >
                ...
                <div className="text-center px-3 md:px-4 py-2 rounded-full border-[3px] border-black text-black text-[8px] md:text-[10px] font-black uppercase tracking-widest shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] bg-white">
                  Guest
                </div>
              </div>
              ...
              <div className="lg:flex-1 lg:flex lg:flex-row  lg:overflow-hidden lg:min-h-0">
                <div className="w-full lg:w-1/3 p-4 overflow-y-auto customScrollbar space-y-6 shrink-0 lg:border-b-[0px] lg:border-b-0 lg:border-r-[3px] lg:border-black bg-[#fdfbf7]">
                  <div className="bg-white lg:border-[3px] border-black rounded-[20px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden w-full">
                    ...
                    <div className="p-4 md:p-5 space-y-4">
                      {creator ? (
                        <div>
                          <div className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-1">Creator</div>
                          <div className="text-sm font-bold text-black">@{creator.username}</div>
                        </div>
                      ) : null}

                      <div>
                        <div className="text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2">Transaction</div>
                        <div className="bg-gray-50 rounded-[15px] border-2 border-black p-4 space-y-2">
                          ...
                          <div className="flex justify-between items-center pt-1">
                            <span className="text-[10px] font-black uppercase tracking-widest text-gray-500">Order</span>
                            <span className="text-xs font-black text-black text-right break-all">{payment?.session_id || payment?.id || '-'}</span>
                          </div>
                        </div>
                      </div>

                      <div className="text-[10px] font-bold text-gray-700 leading-relaxed">
                ...
                <div className="w-full lg:w-2/3 flex flex-col bg-white flex-1 min-h-0">
                  <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 bg-[#fdfbf7] customScrollbar relative">
                    {ticketUuid ? (
                      <div className="bg-white border-[3px] border-black rounded-[20px] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden w-full">
                        <div className="p-4 md:p-5 space-y-3">
                          <div className="text-sm font-black uppercase tracking-widest text-gray-500">Ticket ID</div>
                          <div className="px-4 py-3 rounded-[15px] border-2 border-black bg-yellow-300 font-black text-black break-all">
                            {ticketUuid}
                          </div>
                        ...
                        <div className="p-4 md:p-5 space-y-4">
                          ...
                          {type === 'refund' ? (
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full min-h-[90px] bg-white border-2 border-black rounded-[20px] p-3 font-bold text-sm resize-y focus:ring-0 customScrollbar"
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              className="w-full min-h-[120px] bg-white border-2 border-black rounded-[20px] p-3 font-bold text-sm resize-y focus:ring-0 customScrollbar"
                          ...
                          <div>
                            ...
                            {attachments.length ? (
                              <div className="mb-3 rounded-[15px] border-2 border-black bg-white p-3">
                            ...
                            <button
                              ...
                              className="w-full h-11 rounded-[20px] border-2 border-black bg-gray-50 font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-2"
                            >
                              <Paperclip size={16} strokeWidth={3} /> Choose file
                            </button>
                            <div className="text-[10px] font-bold text-gray-600 mt-2">Up to 5 files. Max 5MB each.</div>
                          </div>
