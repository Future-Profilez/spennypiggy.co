                ...
                <div className='wishlistPage mintbg py-14 '>
                    <div className='containerbox'>
                        <div className='wishbanner '>
                            <img className='w-full  border-black border-2 shadow-black rounded-2xl' src={wishlistbannerimg} alt='img' />
                        </div>
                        <div className='wishManage'>
                            ...
                            <div className='userManageRt mt-14'>
                                <div className='userManageHead flex items-center justify-between mb-8'>
                                    ...
                                    <button className='btn-pink-md'>Add Wishlist</button>
                                </div>
