                        ...
                        <div className="w-full max-w-[550px] px-3">
                            <Suspense fallback={"Loading.."}>
                                <div className="bg-gray-100 w-full p-6 md:p-10 rounded-3xl shadow-lg z-10">
                                    ...
                                    <AddGift classes="font-bold py-3 px-3 mb-2 text-center" updateState={updateState} fetch_gifts={fetch_gifts} />
                                                     ...
                                                     {giftsloading ? (
                                                       ...
                                                       <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6">
                                                         {gifts.map((gift) => {
                                                           ...
                                                           return <GiftListing key={gift.id} details={details} user={user} IsloggedIn={IsloggedIn} fetch_gifts={fetch_gifts} />;
                                                         })}
                                                       </div>
                                                     ) : (
                                                       <div className="col-md-12">
