    ...
    return (
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                {/* Debug Information */}
                <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border mb-6">
                ...
                {/* Instructions */}
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-lg p-6 border">
