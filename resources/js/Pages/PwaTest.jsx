    ...
    return (
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                {/* Debug Information */}
                <div className="bg-white rounded-[30px]   p-6 border mb-6">
                ...
                {/* Instructions */}
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-[30px]   p-6 border">
                ...
                {/* User Agent Info */}
                <div className="mt-6 bg-gray-100 rounded-[30px]   p-4">
                    <details>
