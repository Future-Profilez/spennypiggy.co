        ...
        <AuthenticatedLayout auth={auth}>
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-white dark:bg-neutral-800 rounded-[30px]   p-6 border">
                        ...
                        {canInstall && (
                            <button
                                ...
                                className="mt-4 bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-[30px]  font-medium"
                            >
                                Install PWA Now 🚀
                            </button>
                        )}
                ...
                {/* Debug Information */}
                <div className="bg-white dark:bg-neutral-800 rounded-[30px]   p-6 border mb-6">
                ...
                {/* Instructions */}
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-[30px]   p-6 border">
                ...
                {/* User Agent Info */}
                <div className="mt-6 bg-gray-100 dark:bg-gray-800 rounded-[30px]   p-4">
                    <details>
