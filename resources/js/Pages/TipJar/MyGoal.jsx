...
export default function MyGoal({  IsloggedIn}) {
  ...
  return (
    <div className='mb-6 bg-white/5 backdrop-blur-2xl border border-white/5 rounded-[40px]  overflow-hidden shadow-2xl transition-all hover:border-white/10 group'>
