...
export default function MyGoal({  IsloggedIn}) {
  ...
  return (
    // <div className='mb-6 bg-white/5 backdrop-blur-2xl border border-white/20 rounded-box overflow-hidden transition-all hover:border-white/10 group'>
    <div className='mt-6 pt-4 overflow-hidden  group'>
        {/* <div className="bg-[#FF007F] p-5">
            <h2 className='text-[17px] font-black font-gulfs tracking-[0.15em] uppercase text-white flex items-center gap-3 '>
        ...
        <div className='' >
            ...
            <div className="relative w-full h-[12px] bg-[#F3F4F6] rounded-full overflow-visible mb-6">
                 <div className="h-full bg-[#FF007F] rounded-full relative transition-all duration-1000" 
                    style={{ width: `${percentage}%` }} >
                     <div className="absolute mt-2 top-1/2 right-[-40px] -translate-y-1/2 w-[45px] h-[45px] bg-contain bg-no-repeat pointer-events-none drop-shadow-xl"
                        style={{ backgroundImage: `url('${mouse}')` }} ></div>
                 </div>
            </div>
            
            {/* <div className="hidden flex items-center justify-between pt-4 border-t border-gray-100">
                <span className="text-black/60 font-black text-[12px] tracking-[0.1em] uppercase">Progress</span>
