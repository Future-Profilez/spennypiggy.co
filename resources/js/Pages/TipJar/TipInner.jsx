  ...
  return <div className='tip-wrapper'>
      ...
      <div className={`${classes} p-2 p-md-4  box-inner`}>
          ...
          <div className='border-top p-3 pt-3' >
            ...
            <div className="flex flex-wrap grid grid-cols-2 md:grid-cols-4 gap-3 mb-4 mt-2">
                <button className={`${ selectegTag == 25 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3`} onClick={()=>customAmountTag(25)}  >{formatMultiPrice(25, global_currency)}</button>
                <button className={`${ selectegTag == 50 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3`} onClick={()=>customAmountTag(50)}  >{formatMultiPrice(50, global_currency)}</button>
                <button className={`${ selectegTag == 100 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3`} onClick={()=>customAmountTag(100)}  >{formatMultiPrice(100, global_currency)}</button>
