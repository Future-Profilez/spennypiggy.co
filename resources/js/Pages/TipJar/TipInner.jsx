          ...
          <div className='border-t border-gray-200 p-3 pt-3' >
            ...
            {/* <div className='tip-counter flex items-center justify-between mb-3' >
                ...
                <div className='incresecounter flex items-center' >
                      <button className='pinkbg text-white min-w-[40px] px-2 font-large min-h-[40px]  border  rounded-xl ' onClick={decresevalue} >-</button>
                      <div className='border px-3 py-2 rounded-xl  mx-1' >{tipQuantity}</div>
                      <button className='pinkbg text-white min-w-[40px] px-2 font-large min-h-[40px] border  rounded-xl ' onClick={incresevalue} >+</button>
                </div>
            </div> */}

            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 mb-4 mt-2">
                <button className={`${ selectegTag == 25 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(25)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(25, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 30 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(30)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(30, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 35 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(35)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(35, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 40 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center hidden md:flex items-center !text-[16px] !font-bold `} onClick={()=>customAmountTag(40)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(40, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 45 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(45)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(45, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 50 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(50)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(50, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 75 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(75)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(75, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 85 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(85)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(85, global_currency || "GBP")}</button>
                <button className={`${ selectegTag == 99 ? 'pinkbg text-white' : 'bg-gray-200'} rounded-[20px] p-2 px-3 text-center justify-center  flex items-center !text-[16px] !font-bold`} onClick={()=>customAmountTag(99)}  > <span className='mr-2' dangerouslySetInnerHTML={{ __html: tipheading }} /> {formatMultiPrice(99, global_currency || "GBP")}</button>
            ...
            {selectegTag === 'custom' ? <div className="mb-4 ">
                <div className="relative currency-wrapper " >
                    ...
                    <input className="border-gray-300 border px-4 py-2 w-full focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 rounded-md" value={amount}
            ...
            <div className="mb-3"> 
              <textarea className="border-gray-300 border px-4 py-2 w-full focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 rounded-md" defaultValue={'Just a small token of appreciation 💖'}
            ...
            {auth && auth.user ? '' :
              <>
                ...
                <div className="mb-4">
                  ...
                  <p className='text-sm text-gray-500 mt-1 ' >Your email address is kept private and will not be shown to anyone.</p>
                </div>
              </>
            }
            ...
            <div className='termselect mt-3 mb-3'>
                ...
                <p className="text-gray-500 text-sm mt-1 mb-3" >Your personal email and name will be private.</p>
            </div>
            {turnstileSiteKey ? (
