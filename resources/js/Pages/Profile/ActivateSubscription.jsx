...
export default function ActivateSubscription(props) {
    ...
    return (
        <Authenticated auth={auth?.user} user={user}>
            ...
            <div className='blackbg py-[30px] md:py-[10vh] '>
                <div className='stripboxs max-w-[600px] mb-md-4 mx-auto border-voilet whbg shadow-voilet rounded-[30px] overflow-hidden'>
                    ...
                    <div className='p-6'>
                        <div className='stripNote p-3 p-md-4'>
                            ...
                            <p className='mb-4 text-[18px] text-center'>
                                ...
                                <p className='  text-center text-green-600 text-normal'>Start your subscription today and pay nothing for the first 3 days!</p>
                        </div>
                        <div className='text-center flex justify-center'>
                            <LoaderButton onClick={checkTerms}
                                disabled={loading}
                                className={'button p w-full size-lg '}
