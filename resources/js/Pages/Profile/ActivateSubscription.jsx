        ...
        <Authenticated auth={auth?.user} user={user}>
            ...
            <div className="blackbg py-10 flex items-center lg:h-[85vh] md:py-10 px-4">
                <div className="max-w-5xl mx-auto">
                    <div className="whbg shadow-voilet border-voilet rounded-[30px] md:rounded-[40px]  overflow-hidden">
                        ...
                        <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className='lg:ps-[30px]'>
                                <div className="border border-black rounded-[30px] md:rounded-[40px]   !p-4 md:!p-6">
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-2 text-center">
                                    <div className="border border-black rounded-[30px] md:rounded-[40px]  p-2">
