      ...
      <div className="w-full finishs mb-4 rounded-3xl bg-white !border-voilet  shadow-voilet  ">
            ...
            <div className='p-4'>
                <p className={`mb-4 text-[15px] font-poppins text-center text-gray-700`}>
                     Enjoy a <span className='text-green-700 font-bold text-normal uppercase'>3-days free trial</span> before your monthly subscription begins! Stripe charges £2 a month for this service, and we add a £2 administrator charge due to heightened compliance requirements.
                </p>
