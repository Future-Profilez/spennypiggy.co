...
export default function Index({ auth, sentDeliverables, receivedDeliverables, activeSubscriptions = [] }) {
    ...
    const renderDeliverableCard = (deliverable) => {
        ...
        return (
            <div key={deliverable.id} className={`bg-white rounded-[30px] md:rounded-[40px]  
                ...
                <div className="flex">
                    ...
                    <div className={`hidden sm:flex relative w-full h-auto max-w-[130px] ${type === 'sent' ? "bg-pink-50" : "bg-green-50"}  flex items-center justify-center p-4`}>
                        ...
                        {itemImage ? (
                            ...
                            <div className="h-12 w-12 flex items-center justify-center  rounded-[30px] md:rounded-[40px] ">
                    ...
                    <div className="w-full p-3 md:p-4">
                                                    ...
                                                    <li className='flex items-center flex-wrap'>
                                                        {/* <Popup space="2 md:p-4"  
                                                            ...
                                                            text={<>🎉 View Exclusive Content</>} >
                                                                <img src={deliverable.deliverable_url} alt={deliverable.wish_item?.wishname} className="w-full h-full max-h-[90vh] object-cover rounded-[30px] md:rounded-[40px] " />
                                                        </Popup> */}
                        ...
                        <p>
                            {deliverable.message && (
                                <div className="mt-3 p-3 bg-gray-50 rounded-[30px] md:rounded-[40px] ">
