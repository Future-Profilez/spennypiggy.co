...
export default function Index({ auth, sentDeliverables, receivedDeliverables, activeSubscriptions = [] }) {
    ...
    const renderDeliverableCard = (deliverable) => {
        ...
        return (
            <div key={deliverable.id} className={`bg-white rounded-[30px]  
             ...
             duration-200 mb-2 md:mb-4 border border-2  ${type === 'sent' ? "!border-pink-400" : "border-mint"} `}>
                <div className="flex">
                    ...
                    <div className="w-full p-3 md:p-4">
                                    ...
                                    <div className=''>
                                        <div className='lg:flex justify-between'>
                                            <div>
                                                ...
                                                <button className='cursor-none uppercase text-[10px] bg-black rounded-full px-3 py-1 mt-2 text-white font-black tracking-wider'>
                                                    {deliverable?.product_type === 'shop_item' 
                                                        ? (metadata?.type === 'physical' ? 'Physical Shop Item' : 'Digital Shop Item')
                                                        : deliverable?.product_type.replace('_', ' ')
                                                    }
                                                </button>
                                            </div>
                                            <div className="mt-2">
                                                    ...
                                                    <li className='flex items-center flex-wrap'>
                                                        {/* <Popup space="2 md:p-4"  
                                                            ...
                                                            text={<>🎉 View Exclusive Content</>} >
                                                                <img src={deliverable.deliverable_url} alt={deliverable.wish_item?.wishname} className="w-full h-full max-h-[90vh] object-cover rounded-[30px] " />
                                                        </Popup> */}
                        ...
                        <p>
                            {deliverable.message && (
                                <div className="mt-3 p-3 bg-gray-50 rounded-[30px] ">
