                ...
                <div className="max-w-4xl w-full">
                    <div className="text-center mb-8">
                        ...
                        {process.env.NODE_ENV !== 'production' && currentUrl && (
                            <div className="mb-6 p-3 bg-yellow-50 border border-yellow-200 rounded-[40px]   max-w-2xl mx-auto">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {popularCreators.map(creator => (
                                        <Link
                                            ...
                                            className="block p-3 border border-gray-200 rounded-[40px]   hover:border-blue-300 hover:shadow-md transition-all duration-200 text-center group"
                                        >
                                            <img
                            ...
                            <div className="space-y-3">
                                {helpLinks.map((link, index) => (
                                    <Link
                                        key={index}
                                        href={link.url}
                                        className="block p-3 border border-gray-200 rounded-[40px]   hover:border-blue-300 hover:shadow-md transition-all duration-200 group"
                    ...
                    <div className="text-center mt-8">
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href="/"
                                className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-[40px]   font-medium hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 shadow-lg"
                            >
                                🏠 Back to Home
                            </Link>
                            <Link
                                href="/discover"
                                className="px-8 py-3 bg-white text-gray-700 border border-gray-300 rounded-[40px]   font-medium hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200"
                            >
                                🔍 Discover Creators
                            </Link>
                        </div>
