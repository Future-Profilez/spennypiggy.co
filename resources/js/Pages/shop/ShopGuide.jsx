    ...
    return (
        <div className="pt-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* General guidance */}
                <div className="md:col-span-2 bg-yellow-100 border-[3px] border-black rounded-box p-6">
                    <h3 className="font-black text-xl uppercase tracking-wide mb-4">💡 Best Practices for Creators</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white border-2 border-black p-4 rounded-box ">
