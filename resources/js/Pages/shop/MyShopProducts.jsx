                  ...
                  <div className='shop-item flex justify-between w-full items-center ' >
                     ...
                     <div className='relative'>
                        <Menu as="div" className="relative inline-block text-left">
                           ...
                           >
                              <Menu.Items className="absolute right-0 mt-2 w-40 origin-top-right divide-y divide-gray-100 rounded-[30px]  bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
