            ...
            {shipping.map((variant, index) => (
                <div className="flex items-center justify-between my-2">
                  <div className='countries-selections w-full me-2' >
                     <select className="shop-forms-input bg-gray-200 w-full bg-gray-200 border-0 rounded-[30px] md:rounded-[40px]  p-[12px] px-[20px] "
                  ...
                  <div className="relative  w-full me-2">
                     ...
                     <input
                        type="number" className="shop-forms-input ps-[50px] bg-gray-200 w-full bg-gray-200 border-0 rounded-[30px] md:rounded-[40px]  p-[12px] px-[20px] "
                        name={`variantValue${index}`}
                        placeholder="Shipping Price"
                        onChange={(e) => handleVariantChange(index, 'price', e.target.value)}
                     />
                  </div>
                  <button type="button" className="text-black shop-forms-input bg-gray-200 w-full bg-gray-300 text-[20px] border-0 rounded-[30px] md:rounded-[40px]  p-[8px] px-[20px] max-w-[50px]" onClick={() => handleRemoveVariant(index)}>
                     &times;
                  </button>
               </div>
            ))}
