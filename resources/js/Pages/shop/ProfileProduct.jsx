...
export default function ProfileProduct({item}) {
  ...
  return (
      <article class="max-w-sm w-full bg-white rounded-[25px] shadow-lg overflow-hidden ">
         <div>
            <Link href={url} >
         ...
         <div class="mt-2 sm:mt-4 p-3 sm:p-4 border-t flex justify-between border-gray-200">
            ...
            <button class=" font-bold cursor-pointer hover:underline text-black text-sm sm:text-lg">
                Buy Now 
            </button>
         </div>
      </article>
