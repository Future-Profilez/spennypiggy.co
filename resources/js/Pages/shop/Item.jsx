               ...
               <div className='py-6 md:py-14 max-w-[900px] m-auto' >
                  ...
                  <div className="product-details max-w-[700px] px-2 mx-auto">
                     ...
                     <div className="w-full relative">
                        <img className="w-full max-h-[400px] object-cover rounded-[30px] md:rounded-[40px] " alt="image of a girl posing" src={shop.perma_link}/>
                        {shop.ai_generated == 1 ? <div className='absolute bottom-2 left-2 z-10 bg-black shadow-sm rounded-[30px] md:rounded-[40px]  px-2 py-1 text-[8px] text-white'>MADE WITH AI </div> : ""}
                     </div>
                     ...
                     {shop && shop.is_member == 0 && shop.special_member_price ? <div className='special-discount flex items-center bg-gray-100 border-gray-200 my-3 rounded-[30px] md:rounded-[40px]  px-1 py-2 '>
                        ...
                        <ul className="mb-4 -ml-2 flex md:order-1 md:mb-0">
                           <li>
                              ...
                              href={`https://twitter.com/intent/tweet?url=${url}`} target="_blank"
                               className=" break-words text-gray-500 inline-flex items-center rounded-[30px] md:rounded-[40px]   p-2.5 text-sm hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200"
                           ...
                           <li>
                              <div onClick={instashare}
                               className="cursor-pointer text-gray-500 inline-flex items-center rounded-[30px] md:rounded-[40px]   p-2.5 text-sm hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200"
                           ...
                           <li>
                              <div className="cursor-pointer text-gray-500 inline-flex items-center rounded-[30px] md:rounded-[40px]   p-2.5 text-sm hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200"
                                    aria-label="Facebook"
                                     onClick={fbShare}
                     ...
                     {shop.type === 'physical' ?
                        ...
                        <select onChange={handleVarient} className='bg-white rounded-[30px] md:rounded-[40px]  text-lg capitalize px-4 py-2.5 mb-3 w-full border-0'>
