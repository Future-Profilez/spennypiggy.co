   ...
   return (
      <>
         <div className='grid grid-cols-1 lg:grid-cols-3 gap-3 mb-3 '>
            <AddItem classes="w-full font-bold text-lg shop-start-box shadow-[6px_6px_0px_#000] border-2 border-black px-4 py-4 md:px-6 md:py-8 text-center bg-white rounded-[28px] hover:shadow-[4px_4px_0px_#000] transition-all " update={update} title='+ Start from scratch' />
            <AddItem classes="w-full font-bold text-lg shop-start-box shadow-[6px_6px_0px_#000] border-2 border-black px-4 py-4 md:px-6 md:py-8 text-center bg-white rounded-[28px] hover:shadow-[4px_4px_0px_#000] transition-all " update={update} pre_price={9} pre_title="Taking Smart Notes (Ebook)"  pre_description='Learn the art of note-taking with this extensive guide. Available in PDF format.'  title='Digital Products' />
