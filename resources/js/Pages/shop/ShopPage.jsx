                         ...
                         {loadError ? (
                            <div className='pt-16'>
                               ...
                               <div className='text-center mt-4'>
                                  <button
                                     onClick={fetchItems}
 className='font-black uppercase bg-yellow-300 border-[3px] border-black px-6 py-3 min-h-[44px] rounded-box-sm transition-all hover:translate-x-[2px] hover:translate-y-[2px] focus:outline-none focus-visible:ring-2 focus-visible:ring-black'
                                  >
                                     Try again
                                  </button>
                               </div>
