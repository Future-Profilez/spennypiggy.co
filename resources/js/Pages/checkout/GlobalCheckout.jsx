                        ...
                        {checked && selectedCurrency === "GBP" ? (
                            <>
                                ...
                                <input
                                    ...
                                    className="px-3 py-[12px] text-black w-full bg-gray-200 text-normal border border-gray-300 rounded-[30px] md:rounded-[40px]  mt-2"
                                />
                                <input
                                    type="text"
                                    value={sortCode}
                                        ...
                                        <div
                                            ...
                                            className={`flex items-center justify-between mt-3 ${
                                                ...
                                                method.uuid
                                                    ? "pinkbg text-white"
                                                    : "bg-gray-200"
                                            }  p-3 rounded-[30px] md:rounded-[40px]  cursor-pointer mb-2`}
                                            key={index}
                                        >
