...
export default function AddGift({
    ...
    const AddItem = () => (
        <div className="flex items-center">
            <div className="p-1 rounded-[40px]   bg-[#ffe8f2] flex items-center justify-center w-[50px] min-w-[50px] h-[50px]">
            ...
            {!hasAdded ? (
                <form onSubmit={submitPost}>
                    ...
                    <input
                        ...
                        className="text-normal border-gray-300 border px-3 py-3 text-gray-900 rounded-[40px]  w-full focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500"
                    />
                    <LoaderButton
                        type="submit"
                        disabled={loading}
