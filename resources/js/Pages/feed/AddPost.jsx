...
export default function AddPost(props) {
    ...
    <Popup modalclass='' space="4" size='md' action={close} classes={`dropdown-item text-start p-0 `} text={`Add Post`} >
        {/* <form onSubmit={submitPost} > */}
            ...
            <textarea onChange={handleInput}  name="content" placeholder="Say Something..." className="text-lg border form-input  mt-4 text-post-content form-control" ></textarea>   
           ...
           { rewardImage ? <>
                ...
                <div className="flex align-center justify-content-center flex-wrap" >
                    <select id="countries" onChange={handleInput} name="for_module" class="form-input  
