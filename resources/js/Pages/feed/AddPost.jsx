...
export default function AddPost({item, text, classes, isEdit, title}) {
    ...
    classes={` w-full addop bg-white rounded-[40px]  py-2 px-3 ${classes}`}
    text={text ? text : <AddItem />} >
        {/* <form onSubmit={submitPost} > */}
            ...
            <div className="mt-1 ">
                ...
                className="text-normal border-gray-300 border px-3 py-3 text-lg text-gray-900 rounded-[40px]  mt-4 w-full focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500"/>
                <textarea onChange={handleInput} defaultValue={item?.content || ''}  name="content" placeholder="Say Something..." className="text-lg border-gray-300 border h-[150px] mt-4 w-full rounded-[40px]  px-3 py-3 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500" ></textarea>
                ...
                <div className="flex items-center justify-center flex-wrap" >
                    <select id="countries" defaultValue={item?.for_module} onChange={handleInput} name="for_module" className="border-gray-300 border px-4 py-2 text-md w-full focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 rounded-[40px]  block ">
