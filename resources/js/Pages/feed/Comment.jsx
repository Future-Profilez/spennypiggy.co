...
export default function Comment({c, update}) {
  ...
  const CommentReply = ({item}) => { 
    return <>
      <div className="pt-4 pb-2 bg-gray-100 flex justify-center items-center">
        <div className="bg-white w-full h-auto flex flex-col space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center justify-center space-x-2">
              <div className="block">
                <div className="bg-gray-100 w-auto rounded-xl px-2 ps-0  pb-2">
  ...
  return (
    <div className="comment-box pt-4 pb-3 bg-gray-100 flex justify-center items-center">
      <div className="bg-white w-full h-auto   flex flex-col space-y-2">
