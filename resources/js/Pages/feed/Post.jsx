...
export default function Post({item}) {
  ...
  return (
    <>
      <div className=" post-wrap bg-[#fdfbf7] rounded-[20px] md:rounded-[30px] p-[15px] xl:p-6 !mb-4 md:!mb-[22px] border-[3px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all">
