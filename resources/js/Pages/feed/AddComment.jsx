    ...
    return <>
      <div className="headerpost mt-3 flex items-center">
        <form onSubmit={addCommmnt} className='flex w-full relative' >
          <input id="user-comment" onChange={(e)=>setReply(e.target.value)} value={reply} className='border text-dark rounded-[30px] md:rounded-[40px]  me-3 ' type="text" placeholder="Add comment..." />
