    ...
    return <>
      <div className="headerpost mt-3 flex items-center">
        <form onSubmit={addCommmnt} className='flex w-full relative' >
          <input id="user-comment" onChange={(e)=>setReply(e.target.value)} value={reply} className='border p-4 !border-gray-200 !bg-gray-100 !text-black rounded-[20px] md:rounded-[20px]  me-3 ' type="text" placeholder="Add comment..." />
          <div disabled={reply == ''} className='absolute top-[18px] right-2' onClick={addCommmnt}>
            {loading ?
              ...
              <svg aria-label="Share Post" className="x1lliihq x1n2onr6 x1roi4f4" fill="#000000" height="24" role="img" viewBox="0 0 24 24" width="24">
                ...
                <line fill="none" stroke="#000000" strokeLinejoin="round" strokeWidth="2" x1="22" x2="9.218" y1="3" y2="10.083"></line>
                <polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="#000000" strokeLinejoin="round" strokeWidth="2"></polygon>
              </svg>
            }
        </div>
        </form>
