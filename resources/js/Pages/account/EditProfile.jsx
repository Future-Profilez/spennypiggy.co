                    ...
                    <div className="profilePhotoImg dp">
                        <img
                            src={
                                profileDP
                                    ? profileDP
                                    : user?.avatar_url || userdefaultphoto
                            }
                            alt="img"
                        />
                        <UpdateAvatar
                    ...
                    <ul>
                        ...
                        <li className="mb-2">
                            ...
                            <input
                                ...
                                name="username"
                                className="form-input px-2 py-2 border w-full rounded-md"
                                placeholder="Spennypiggy.co/warner99"
                                onKeyUp={(e) => {
                        ...
                        <li>
                            <strong className="d-block text-start mb-4">
                        ...
                        <li className="mb-3">
                            ...
                            {/* global_currency */}
                            <p className="mt-1">
                                The Minimum amount is set to{" "}
                                {formatMultiPrice(
                                    user?.min_surprise_amount || 0,
                                    defaultCurrency
                                )}
                                .
                            </p>
