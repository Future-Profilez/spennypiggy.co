                ...
                {CoverUploadingStart ? 
                    <div className='py-4'>
                        <div className='flex items-center justify-between'>
                            ...
                            <button type="button" onClick={()=>setCoverUploadingStart(false)} className='mr-4 mt-4 bg-gray-200 px-4 py-1 rounded-[10px] md:rounded-[15px]'>Exit</button>
                        </div>
                            <UpdateAvatar type="cover" getImageUID={getCoverUID}
                                    text={<> <button type="button" className='editbtn'> <img src={editicon} alt="img" /> </button> </>} />
