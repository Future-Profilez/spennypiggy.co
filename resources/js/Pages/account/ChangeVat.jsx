...
export default function ChangeVat({defaultvalue, updatevat}) {
   ...
   return <>
      ...
      <div className="form-field mb-4">
          ...
          <input defaultValue={defaultvalue} onChange={handleinput} type="number" placeholder="VAT Percent" className="input-field w-full border rounded-[30px] md:rounded-[40px]  p-3 py-3" />
      </div>
