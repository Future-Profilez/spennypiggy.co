                    ...
                    <div className="membershipdashboard pb-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center text-black">
                            <div className="w-full">
                                <div className="box dash-stat-block bg-white border border-gray-100 shadow-sm rounded-[30px] md:rounded-[40px]   relative w-full ">
                            ...
                            <div className="w-full">
                                <div className="box dash-stat-block bg-gray-50 border border-gray-100 shadow-sm rounded-[30px] md:rounded-[40px]   relative w-full">
