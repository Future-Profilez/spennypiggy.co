          ...
          <div className="containerbox mx-auto">
            ...
            <div className="pt-12 pb-16 md:pt-24 md:pb-20 text-center">
               ...
               <div className="grid lg:grid-cols-2 gap-3 md:gap-8 max-w-5xl mx-auto">
                  ...
                  <div className="bg-white p-4 md:!p-8 lg:!p-10 rounded-[40px]  md:rounded-[40px]  shadow-xl border border-gray-100 relative overflow-hidden group hover:border-yellow-400 transition-colors"> 
                     <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                        <Award size={150} />
                     </div>
                     <div className="relative z-10 text-left">
                        <div className="bg-yellow-100 w-12 h-12 md:w-16 md:h-16 rounded-[40px]   flex items-center justify-center mb-6 text-yellow-600">
                           <Award size={32} />
                        </div>
                  ...
                  <div className="bg-black text-white p-4 md:!p-8 lg:!p-10 rounded-[40px]  md:rounded-[40px]  shadow-xl relative overflow-hidden group">
                     <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
                        <Clock size={150} />
                     </div>
                     <div className="relative z-10 text-left">
                        <div className="bg-white/10 w-12 h-12 md:w-16 md:h-16 rounded-[40px]   flex items-center justify-center mb-6 text-pink-500">
                           <AlertCircle size={32} />
                        </div>
