    ...
    <>
      ...
      <Guest>
        <div className="bg-[#F9F9F9] min-h-screen font-sans text-gray-900 pb-20 flex flex-col items-center justify-center relative overflow-hidden">
          ...
          <div className="max-w-7xl w-full mx-auto px-6 py-12 md:py-24 relative z-10">
            ...
            <div className="text-center max-w-4xl mx-auto mb-16">
               ...
               <h1 className="text-5xl md:text-8xl font-gulfs uppercase leading-[0.9] tracking-tighter mb-8 text-black">
                  Disputes Are <br/>
                  Managed By <br/>
                  <span className="text-gray-400">The Platform.</span>
               </h1>
            ...
            {/* The Badge Container */}
            <div className="max-w-5xl mx-auto bg-white rounded-[3rem] shadow-2xl border border-gray-100 overflow-hidden relative">
               
               {/* Decorative Background */}
               <div className="absolute top-0 left-0 w-full h-4 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600"></div>
               
               <div className="grid md:grid-cols-2">
                  
                  {/* Left: How It Works */}
                  <div className="p-10 md:p-16 border-b md:border-b-0 md:border-r border-gray-100">
                     <h2 className="text-3xl font-gulfs uppercase mb-8 flex items-center gap-3 text-black">
                        <FileCheck size={32} className="text-gray-900" /> How It Works
                     </h2>
                     <ul className="space-y-8">
                        <li className="flex gap-4">
                           <div className="bg-gray-100 p-3 rounded-xl h-fit shrink-0">
                              <FileCheck size={24} className="text-gray-700" />
                           </div>
                           <div>
                              <p className="text-xl font-bold text-gray-800">Every transaction includes delivery receipts or activity logs.</p>
                           </div>
                        </li>
                        <li className="flex gap-4">
                           <div className="bg-gray-100 p-3 rounded-xl h-fit shrink-0">
                           ...
                           <div>
                              <p className="text-xl font-bold text-gray-800">All actions are time-stamped.</p>
                           </div>
                        </li>
                     </ul>
                  </div>
                  ...
                  <div className="p-10 md:p-16 bg-gray-50">
                     ...
                     <ul className="space-y-8">
                        <li className="flex gap-4">
                           <div className="bg-pink-100 p-3 rounded-xl h-fit shrink-0 text-pink-600">
                              <Check size={24} strokeWidth={3} />
                           </div>
                           <div>
                              <p className="text-xl font-bold text-gray-800">Creators are never debited.</p>
                           </div>
                        </li>
                        <li className="flex gap-4">
                           <div className="bg-pink-100 p-3 rounded-xl h-fit shrink-0 text-pink-600">
                           ...
                           <div>
                              <p className="text-xl font-bold text-gray-800">Chargebacks are handled by Spenny Piggy.</p>
                           </div>
                        </li>
                     </ul>
                  </div>
               ...
               <div className="bg-black text-white p-10 md:p-12 text-center border-t border-gray-100">
                  ...
                  <p className="text-2xl md:text-3xl font-gulfs leading-tight max-w-3xl mx-auto">
