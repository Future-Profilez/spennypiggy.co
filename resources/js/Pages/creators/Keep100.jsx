          ...
          <div className="containerbox mx-auto">
            <div className="pt-12 md:pt-18 lg:pt-32">
              ...
              <div className="grid md:grid-cols-2 gap-6 md:gap-10">
                 ...
                 <div className="bg-white p-4 sm:!p-8 md:!p-10 lg:!p-14 rounded-[30px]  md:rounded-[30px]  shadow-xl border border-gray-100 hover:border-pink-500 transition-all group">
                    <div className="bg-pink-100 w-16 h-16 md:w-20 md:h-20  rounded-[30px]   flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
                 ...
                 <div className="bg-black text-white p-4 sm:!p-8 md:!p-10 lg:!p-14 rounded-[30px]  md:rounded-[30px]  shadow-xl relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-10 opacity-10 group-hover:opacity-20 transition-opacity">
                       <ShieldCheck size={180} className="text-white" />
                    </div>
                    
                    <div className="bg-white/10 w-16 h-16 md:w-20 md:h-20 rounded-[30px]   flex items-center justify-center mb-8 relative z-10 group-hover:scale-110 transition-transform">
