        ...
        <div className="bg-[#F9F9F9] min-h-screen font-sans text-gray-900 pb-12 md:pb-20 relative overflow-hidden">
            ...
            <div className='containerbox mx-auto'>
               ...
               <div className="relative z-1">
                  ...
                  <div className=" grid lg:grid-cols-2 gap-0 overflow-hidden rounded-[2rem] md:rounded-[3rem] shadow-2xl border border-gray-200">
                     ...
                     <div className="bg-black text-white p-4 sm:!p-8 md:!p-12 lg:!p-16 flex flex-col justify-center border-b md:border-b-0 md:border-r border-gray-800">
                        ...
                        <ul className="space-y-8">
                           <li className="flex gap-4">
                              <div className="bg-red-500/20 p-3 rounded-xl h-fit shrink-0">
                  ...
                  <div className=" mt-12">
                     <div className="bg-white border border-gray-100 text-gray-900 p-4 md:!p-8 lg:!p-12 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-10 shadow-xl">
                        <div>
