        ...
        <div className="bg-[#A2E4B8] min-h-dvh font-sans text-gray-900 pb-12 md:pb-16 relative">
            ...
            <div className='containerbox mx-auto'>
               <div className="relative z-1">
                  ...
                  <div className=" grid lg:grid-cols-2 gap-0 overflow-hidden rounded-[25px] md:rounded-[30px]  border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  <div className=" mt-12">
                     <div className="bg-[#fdfbf7] text-gray-900 p-4 md:!p-8 lg:!p-12 rounded-[25px] md:rounded-[30px]  border-[3px] border-black flex flex-col md:flex-row items-center justify-between gap-10 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                        <div>
