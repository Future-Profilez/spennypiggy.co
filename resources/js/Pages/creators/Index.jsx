            ...
            <div className="relative z-1">
              <div className=" pt-12 pb-16 md:pt-24 md:pb-24">
                <div className="max-w-4xl">
                  <h1 className="text-3xl md:text-6xl lg:text-7xl  font-gulfs uppercase leading-[0.9] tracking-wide mb-8 text-black">
                    Creators <br/>
                    ...
                    <span className="text-gray-400">We Protect Your Payouts.</span>
                  </h1>
              ...
              <div className="py-20 relative z-10">
                <div className="">
                  <h2 className="text-3xl md:text-5xl font-gulfs uppercase mb-12 flex flex-wrap items-center gap-3 text-black">
                    Why Creators <span className="text-pink-600">Choose This</span>
                  </h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      {[
                        ...
                        return (
                          <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-lg hover:border-pink-500 transition-colors group">
                    ...
                    <div className="bg-black text-white p-8 rounded-[2.5rem] relative overflow-hidden flex flex-col justify-center shadow-2xl">
                      ...
                      <div className="relative z-10">
                          <h2 className="text-3xl md:text-4xl font-gulfs uppercase mb-6 leading-none">
                            Founder Bonuses <br/> for Early Creators
                          </h2>
              ...
              <div className=" py-24">
                <div className="grid lg:grid-cols-2 gap-20">
                  <div className='lg:pt-12'>
                    ...
                    <ul className="space-y-6">
                      {[
                        ...
                        <li key={i} className="flex items-start gap-4 text-lg font-medium text-gray-700">
                  ...
                  <div className="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-xl border border-gray-100">
                    <h2 className="text-3xl md:text-4xl font-gulfs uppercase mb-8 text-black">
                      ...
                      {[
                        ...
                        return (
                            <li key={i} className="group">
                              <h3 className="font-bold text-xl flex items-center gap-2 group-hover:text-pink-600 transition-colors text-gray-900">
              ...
              {/* Section: Account Safety & Disputes */}
                    ...
                    <div className="mb-20">
                      ...
                      <div className="max-w-3xl mx-auto text-center mb-10">
                          ...
                          <p className="text-xl font-bold text-black">That’s why Spenny Piggy:</p>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                          {[
                            ...
                            <div key={i} className="bg-gray-50 p-6 rounded-2xl text-center flex flex-col items-center justify-center border border-gray-100 hover:border-pink-500 transition-colors hover:shadow-lg">
                                <p className="font-bold text-gray-80 text-lg">{item}</p>
                            </div>
                          ))}
                      </div>
                      <p className="text-center mt-8 text-xl font-medium text-gray-500">This is why Stripe remains an option.</p>
                    </div>

                    {/* Disputes */}
                    <div className="bg-black text-white rounded-[3rem] p-8 md:p-16 relative overflow-hidden shadow-2xl">
                      ...
                      <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                          <div>
                            <h2 className="text-3xl md:text-5xl font-gulfs uppercase mb-6">
                            ...
                            <p className="text-xl font-bold text-white border-l-4 border-pink-500 pl-4">
                          ...
                          <div className="bg-white/10 p-8 rounded-[2rem] border border-white/10 backdrop-blur-sm">
                            <h3 className="text-xl font-bold uppercase mb-6 text-red-400 flex items-center gap-2">
                                <AlertTriangle size={70} /> Why Creators Lose Money on Other Payment Apps
                            </h3>
                            ...
                            <p className="text-black font-bold text-lg text-center bg-white py-3 px-4 rounded-xl">
