            ...
            <div className="relative z-1">
                  ...
                  <div className="grid lg:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      {[
                        ...
                        return (
                          <div key={i} className="bg-white p-3 md:p-6 rounded-[40px]   border border-gray-100 shadow-lg hover:border-pink-500 transition-colors group">
                            <div className="flex gap-2 md:!gap-4">
                              <div className="bg-pink-100 text-pink-600 p-2 rounded-[40px]   h-fit shrink-0 group-hover:bg-pink-600 group-hover:text-white transition-colors">
                    ...
                    <div className="bg-black text-white p-8 rounded-[40px]  relative overflow-hidden flex flex-col justify-center shadow-2xl">
              ...
              <div className=" py-12 md:py-24">
                <div className="grid lg:grid-cols-2 gap-20">
                  ...
                  {/* Toolkit */}
                  <div className="md:bg-white  md:p-10 rounded-[40px]  shadow-xl md:border border-gray-100">
              ...
              {/* Section: Account Safety & Disputes */}
                    ...
                    <div className="mb-20 py-4 md:py-20">
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4">
                          {[
                            ...
                            <div key={i} className="bg-gray-100 p-4 md:p-6 rounded-[40px]   text-center flex flex-col items-center justify-center border border-gray-100 hover:border-pink-500 transition-colors hover:shadow-lg">
                    ...
                    {/* Disputes */}
                    <div className="bg-black text-white rounded-[40px]  md:rounded-[40px]  
                     p-4 md:!p-16 relative overflow-hidden shadow-2xl">
                      ...
                      <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                          ...
                          <div className="md:bg-white/10 md:p-8 rounded-[40px]  md:border md:border-white/10 backdrop-blur-sm">
                            ...
                            <p className="text-black font-bold text-sm md:text-lg text-center bg-white py-3 px-4 rounded-[40px] ">
