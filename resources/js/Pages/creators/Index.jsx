            ...
            <div className="relative z-1">
                ...
                <div className="max-w-4xl">
                  <div className=" ">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row gap-3 items-start">
                      ...
                      <span className="text-xs md:text-sm font-medium text-gray-700">3 days free • £8.99/month after • Cancel anytime</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center py-4 md:py-12 px-6">
                ...
                <div className="mt-2 text-sm font-medium text-gray-700">
                  3 days free • £8.99/month after • Live support included
                </div>
              </div>
