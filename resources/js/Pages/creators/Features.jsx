        ...
        <div className="bg-[#F9F9F9] min-h-screen font-sans text-gray-900 pb-12 md:pb-20 relative overflow-hidden">
          ...
          <div className="relative z-1">
            ...
            <div className="pt-12 pt-16 md:pt-24 md:pt-20">
              ...
              <div className="bg-white p-8 md:p-12 rounded-[30px] md:rounded-[40px]  shadow-sm border border-gray-100 mb-16">
              ...
              <div className="mb-12 md:mb-20">
                 ...
                 <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {[
                       ...
                       <div key={i} className="bg-white p-6 rounded-[30px] md:rounded-[40px]  hover:-translate-y-2 transition-transform duration-300 border border-gray-100 hover:border-pink-500 shadow-sm hover:shadow-xl group">
                          <div className="bg-gray-100 w-14 h-14 rounded-[30px] md:rounded-[40px]  flex items-center justify-center mb-6 group-hover:bg-pink-600 group-hover:text-white transition-colors">
              ...
              <div className="bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 rounded-[30px] md:rounded-[40px]  lg:rounded-[30px] md:rounded-[40px]  p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
                 <div className="relative z-1"> 
