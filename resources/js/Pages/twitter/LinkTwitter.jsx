...
export default function LinkTwitter(props) {
  ...
  const TwitterCard = () => {
    return <div className='t-card bg-gray-50 box p-3 rounded-[30px] md:rounded-[40px]   shadow-md'>
            <Avatar 
  ...
  return (
    ...
    <div className='step1' >
      ...
      {/* <div className='twitter-img' >
        <img src={twitter} alt='twitter' className='w-full rounded-[30px] md:rounded-[40px]   mt-3' />
      </div> */}
