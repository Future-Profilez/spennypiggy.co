            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 md:py-16 lg:py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {auth && auth?.user && auth?.user?.is_founder && founderBonusData && (
                        <div className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 rounded-[30px] md:rounded-[40px]  shadow-xl ring-1 ring-white/20 p-4 md:p-6 mb-8 text-white relative overflow-hidden">
                            ...
                            <div className="relative">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                                    <div className="fading bg-black/5 rounded-[30px] md:rounded-[40px]  p-3 backdrop-blur-sm text-center">
                                ...
                                <div className="fading bg-black/5 rounded-[30px] md:rounded-[40px]  p-3 backdrop-blur-sm mb-3">
                                ...
                                {founderBonusData.payout_status === 'pending' && (
                                    <div className="text-center bg-black/5 rounded-[30px] md:rounded-[40px]  p-3 backdrop-blur-sm">
                                ...
                                {founderBonusData.payout_status === 'rejected' && founderBonusData.rejection_reason && (
                                    <div className="text-center bg-red-500/20 rounded-[30px] md:rounded-[40px]  p-3 backdrop-blur-sm">
                    ...
                    {auth && auth?.user && auth?.user?.role == 1 && userInRace && userProgress && (
                        <div className=" pinkbg rounded-[30px] md:rounded-[40px]  md:rounded-[30px] md:rounded-[40px]  shadow-2xl p-6 md:p-8 mb-12 text-white relative overflow-hidden">
                            ...
                            {userProgress?.is_qualified 
                                ...
                                : `💪 ${formatMultiPrice(minEarnings - userProgress?.current_earnings, 'GBP')} away from Founder Badge!`
                                    ...
                                    <div className="mt-3 text-right bg-white/10 rounded-[30px] md:rounded-[40px]   p-3 md:p-2 backdrop-blur-sm flex items-center">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                                    <div className="bg-black/5 fading rounded-[30px] md:rounded-[40px]   p-4 backdrop-blur-sm">
                                ...
                                {!userProgress?.is_qualified && (
                                    <div className="mt-6 bg-white/10 rounded-[30px] md:rounded-[40px]   p-4 backdrop-blur-sm">
                    ...
                    <div className="pt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
                        ...
                        <div className="bg-white fading rounded-[30px] md:rounded-[40px]  shadow-[5px_5px_0_0_var(--yellow)] !border-2 border-[var(--yellow)] p-6">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-white fading rounded-[30px] md:rounded-[40px]  shadow-[5px_5px_0_0_var(--mint)] !border-2 border-[var(--mint)] p-6">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-white fading rounded-[30px] md:rounded-[40px]  shadow-[5px_5px_0_0_var(--pink)] !border-2 border-[var(--pink)] p-6">
                            <div className="flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-white fading rounded-[30px] md:rounded-[40px]  shadow-[5px_5px_0_0_var(--black)] !border-2 border-[var(--black)] p-6">
                            <div className="flex items-center justify-between">
                                <div>
                    ...
                    <div className="mt-16 mb-8">
                        ...
                        <div className="py-6 overflow-auto">
                            ...
                            <table className='w-full table-auto border-collapse border border-gray-200 shadow-sm rounded-[30px] md:rounded-[40px]  overflow-hidden bg-gray-100'>
                                <thead>
                                    <tr>
                    ...
                    <div className="bg-whites rounded-[30px] md:rounded-[40px]  mt-16 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center bg-white fading p-6 rounded-[30px] md:rounded-[40px] ">
