            ...
            <>
                <div className="filters block sm:flex items-center justify-between w-full mb-4">
                    ...
                    <div className="flex items-center">
                        ...
                        text-sm rounded-[40px]  focus:ring-blue-500 focus:border-blue-500
                ...
                <div className="mt-3 mb-2 tagsfilterbar flex flex-wrap">
                    <button onClick={() => fetch_wishes(page, "")}
                        className={` me-2 mb-2  rounded-[40px]  text-[14px] p-2 px-3 ${ tag == "" ? "bluebg text-white" : "bg-gray-300"}`}>All</button>
                    {lists &&
                        lists.map((l, i) => {
                            return (
                                <button
                                    onClick={() => fetch_wishes(page, l)}
                                    className={` me-2 mb-2  rounded-[40px]  text-[14px] p-2 px-3 ${
