            ...
            <div className="container max-w-7xl mx-auto px-4 py-3">
                ...
                <div className="relative mb-3">
                    ...
                    {isFocused && (recentSearches.length > 0 || query) && (
                        <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-[40px]   shadow-xl border border-gray-100 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
                            <div className="p-2">
                                    ...
                                    <>
                                        ...
                                        {recentSearches.map((term, index) => (
                                            <div 
                                                ...
                                                className="hover:bg-gray-50 px-3 py-2 rounded-[40px]   cursor-pointer flex items-center gap-2 group"
                                            >
                                ...
                                {query && (
                                    <>
                                        <div 
                                            ...
                                            className="hover:bg-gray-50 px-3 py-2 rounded-[40px]   cursor-pointer flex items-center gap-2 text-pink-600 font-medium border-t border-gray-100 mt-1"
                                        >
                                            <RiSearchLine />
                                            Search for "{query}"
                                        </div>
                                                ...
                                                {suggestions.creators?.length > 0 && (
                                                    <>
                                                        ...
                                                        {suggestions.creators.map((item, i) => (
                                                            ...
                                                            //     key={`c-${i}`} 
                                                            //     href={s.url}
                                                            //     className="hover:bg-gray-50 px-3 py-2 rounded-[40px]   cursor-pointer flex items-center gap-3"
                                                            // >
                                                    ...
                                                    <>
                                                        ...
                                                        {suggestions.wishes.map((s, i) => (
                                                            <div 
                                                                ...
                                                                className="hover:bg-gray-50 px-3 py-2 rounded-[40px]   cursor-pointer flex items-center gap-3"
                                                            >
                                                                <img src={s.image || 'https://via.placeholder.com/30'} className="w-8 h-8 rounded-[40px]  object-cover" />
                                                                <div>
