                ...
                <div className="p-5">
                    ...
                    */}
                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative flex-1">
                                ...
                                <input 
                                    type="number" 
                                    placeholder="Min" 
                                    className="w-full pl-6 pr-2 py-2 rounded-xl  border border-gray-200 text-sm focus:ring-pink-500 focus:border-pink-500"
                    ...
                    <div className="mb-8 border-t border-gray-100 pt-6">
                        ...
                        <select 
                            className="w-full rounded-xl  border-gray-200 text-gray-700 focus:ring-pink-500 focus:border-pink-500"
