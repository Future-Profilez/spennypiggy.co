...
export default function CategoryLeaders() {
    ...
    if (loading) {
        return (
            <div className="animate-fading bg-gray-100 rounded-[30px] md:rounded-[40px]  p-4 mb-6 flex justify-center items-center min-h-[400px]">
    ...
    if (error) {
        return (
            <div className="animate-fading bg-gray-100 rounded-[30px] md:rounded-[40px]  p-4 mb-6 text-center">
    ...
    return (
        <div className="bg-gray-100 rounded-[30px] md:rounded-[40px]  p-4 mb-6 mt-6">
                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`animate-fading category-tab flex items-center space-x-2 px-4 py-2 rounded-[30px] md:rounded-[40px]   font-medium transition-all ${
