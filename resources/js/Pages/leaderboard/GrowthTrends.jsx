...
export default function GrowthTrends() {
    ...
    const TrendCard = ({ title, value, change, icon: Icon, type = 'positive' }) => (
        <div className="trend-card bg-white rounded-[40px]   p-4 shadow-sm">
    ...
    const CreatorCard = ({ creator, rank, badge }) => (
        <div className="creator-growth-card bg-white rounded-[40px]   p-4 mb-3 shadow-sm hover:shadow-md transition-shadow">
    ...
    if (loading) {
        return (
            <div className="bg-gray-100 rounded-[40px]  p-4 mb-6 flex justify-center items-center" style={{minHeight: '300px'}}>
