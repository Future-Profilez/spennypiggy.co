...
export default function TopSupporters({grid = false}) {
  ...
  if (loading) {
    return (
      <div className="bg-gray-100 rounded-[40px]  p-4 mb-6 flex justify-center items-center" style={{minHeight: '200px'}}>
  ...
  return (
    <>
    {data && data.length > 0 ? <div className="bg-gray-100 rounded-[40px]  p-4 mb-6">
