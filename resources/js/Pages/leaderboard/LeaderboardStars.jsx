...
export default function LeaderboardStars() {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-box ring-1 ring-inset ring-black/[0.06] p-4 flex justify-center items-center" style={{minHeight: '200px'}}>
  ...
  if (error) {
    return (
      <div className="bg-white rounded-box ring-1 ring-inset ring-black/[0.06] p-4 text-center">
