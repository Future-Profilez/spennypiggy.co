...
export default function LeaderboardStars() {
  ...
  if (loading) {
    return (
      <div className="bg-gray-100 rounded-[40px]  p-4 flex justify-center items-center" style={{minHeight: '200px'}}>
  ...
  if (error) {
    return (
      <div className="bg-gray-100 rounded-[40px]  p-4 text-center">
  ...
  return (
   <>
    {lists.length > 0 ?  <div className="bg-gray-100 rounded-[40px]  p-4">
