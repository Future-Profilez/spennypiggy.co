            ...
            <> 
                {p && p.username ? (
                    <Link
                        ...
                        className={` position-${position} position text-center rounded-[40px]  md:rounded-[40px]   
                    ...
                    <div
                        className={`position-${position} position text-center rounded-[40px]   shadow-pink bg-white`}
                    >
            ...
            <div className="bg-white pt-4">
                ...
                <div className="flex flex-wrap -mx-4">
                    <div className="w-full xl:w-2/3 px-4 mb-4">
                        <div className=" ">
                            <div className="p-2  md:!p-6 pinkbg rounded-[40px]  mb-6">
                                ...
                                {ranks && ranks.length ? (
                                    ...
                                    className={`${
                                        loading ? "opacity-50 pointer-events-none" : ""
                                        }  rank_lists bg-gray-100 p-3 md:p-4  rounded-[40px]  `}
                                        >
