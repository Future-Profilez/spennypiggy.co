...
export default function AchievementSystem() {
    ...
    const AchievementCard = ({ achievement }) => {
        ...
        return (
            <div className="achievement-card bg-white rounded-xl  p-4 shadow-sm hover:shadow-md transition-shadow">
    ...
    const MilestoneCard = ({ milestone }) => (
        <div className="milestone-card bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl  p-6 shadow-lg">
    ...
    const BadgeCategoryCard = ({ category, badges }) => (
        <div className="badge-category bg-white rounded-xl  p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {badges.map((badge, index) => {
                    ...
                    return (
                        <div key={index} className="badge-item text-center p-4 border rounded-xl  hover:shadow-sm transition-shadow">
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`achievement-tab flex items-center space-x-2 px-4 py-2 rounded-xl  font-medium transition-all ${
                                    activeTab === tab.key
