...
export default function AchievementSystem() {
    ...
    const AchievementCard = ({ achievement }) => {
        ...
        return (
            <div className="achievement-card bg-white rounded-[40px]   p-4 shadow-sm hover:shadow-md transition-shadow">
    ...
    const MilestoneCard = ({ milestone }) => (
        <div className="milestone-card bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-[40px]   p-6 shadow-lg">
    ...
    const BadgeCategoryCard = ({ category, badges }) => (
        <div className="badge-category bg-white rounded-[40px]   p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {badges.map((badge, index) => {
                    ...
                    return (
                        <div key={index} className="badge-item text-center p-4 border rounded-[40px]   hover:shadow-sm transition-shadow">
    ...
    if (loading) {
        return (
            <div className="bg-gray-100 rounded-[40px]  p-4 mb-6 flex justify-center items-center" style={{minHeight: '400px'}}>
    ...
    if (error) {
        return (
            <div className="bg-gray-100 rounded-[40px]  p-4 mb-6 text-center">
    ...
    return (
        <div className="bg-gray-100 rounded-[40px]  p-4 mb-6">
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`achievement-tab flex items-center space-x-2 px-4 py-2 rounded-[40px]   font-medium transition-all ${
                                    activeTab === tab.key
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-4 bg-white rounded-[40px]  ">
