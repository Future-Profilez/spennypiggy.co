            ...
            <LegalLayout activePage="CopyrightPolicy">
                <div className="mx-auto p-8 md:p-12">
                    ...
                    <div className="prose prose-pink max-w-none">
                        <p className="mb-4 text-gray-700 leading-relaxed italic">Last Updated: May 2026</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">1. Creator Responsibility</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">2. Prohibited Infringing Content</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">3. Reporting Copyright Infringement</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed font-bold">
                            support@spennypiggy.co or via live chat or via the report content button on each creators profile.
                        </p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">4. Takedown Procedure</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">5. Counter-Notices</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">6. Repeat Infringer Policy</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">8. Trademarks</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">9. Contact</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">
