            ...
            <LegalLayout activePage="MorAgreement">
                <div className="mx-auto p-8 md:p-12">
                    ...
                    <div className="prose prose-pink max-w-none">
                        ...
                        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mt-8 mb-4">MERCHANT OF RECORD CONFIRMATION</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">Stripe Connect Onboarding — Creator Acknowledgement</p>
                        ...
                        <div className="bg-pink-50/50 rounded-2xl p-6 md:p-8 mb-8 border border-pink-100">
                            ...
                            <p className="mb-6 text-gray-800 font-medium">I confirm that I understand and agree that I am the Merchant of Record (“MoR”) for all payments made by supporters to me through Spenny Piggy.</p>
                            
                            <h4 className="text-sm font-bold text-pink-600 uppercase tracking-wider mb-4">I Acknowledge and Agree That:</h4>
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 md:p-8 mb-8 border border-gray-100">
                            <h3 className="text-lg font-bold text-gray-900 mb-4">Final Acceptance</h3>
