...
<h2 className="text-xl md:text-2xl font-black text-gray-900 mt-8 mb-4">PAYMENTS, PAYOUTS & RESERVES POLICY</h2>
...
<p className="mb-4 text-gray-700 leading-relaxed">US Entity: Social Vortex, Inc (Delaware, USA)</p>
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">1.  Platform Overview and Role</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">1.1  Spenny Piggy is a technology platform that enables transactions between users. It is not a bank, financial institution, payment service provider, or regulated entity in respect of the transactions it facilitates.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">1.2  For all creator-led transactions processed via the Platform, the Creator acts as the Merchant of Record. All payments are processed via third-party payment providers and are subject to platform review, fraud checks, dispute monitoring, and compliance controls.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">1.3  In connection with transactions conducted through the Platform, Spenny Piggy:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">1.4  Spenny Piggy does not act as a bank or financial institution in respect of any funds held or disbursed through the Platform.</p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">2.  Payment Processing</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">2.1  All payments are processed through third-party payment providers. Payments are made to Creators as Merchant of Record and are subject to the rules and controls of the applicable payment processor and to Spenny Piggy’s own risk and compliance review.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">2.2  For the purposes of risk assessment and fraud prevention, Spenny Piggy may monitor, without limitation:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">3.  Payout Schedule</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">3.1  Creators are paid on a weekly payout cycle. The standard earnings period runs from Friday to Thursday, with the standard payout day being the following Friday.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">3.2  Payouts are not guaranteed on any specific date and remain subject to:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">4.  Payment Reviews and Delays</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">4.1  For the purposes of protecting users, payment partners, and the integrity of the Platform, Spenny Piggy reserves the right to delay, pause, split, reverse, or refuse any payout at its sole discretion.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">4.2  Such action may be taken where Spenny Piggy detects or reasonably suspects, without limitation:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">5.  Reserve Policy</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">5.1  To manage payment risk, Spenny Piggy may apply a rolling reserve to any Creator account. A reserve constitutes the temporary withholding of a percentage of earnings prior to disbursement, pending release in accordance with this Policy.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">5.2  Spenny Piggy applies reserves in accordance with the following standard framework, based on each account’s risk classification:</p>
                        
                        <div className="overflow-x-auto my-8">
                            <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-xl overflow-hidden">
                                <thead className="bg-gray-50">
                                    <tr>
                                        <th scope="col" className="px-6 py-4 text-left text-xs font-black text-gray-500 uppercase tracking-wider">Account Classification</th>
                                        <th scope="col" className="px-6 py-4 text-left text-xs font-black text-gray-500 uppercase tracking-wider">Reserve Rate</th>
                                        <th scope="col" className="px-6 py-4 text-left text-xs font-black text-gray-500 uppercase tracking-wider">Holding Period</th>
                                    </tr>
                                </thead>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">5.3  In addition to the standard framework set out above, Spenny Piggy may apply a full temporary hold on all funds where required for:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">5.4  Spenny Piggy reserves the right to apply, modify, or remove reserves at any time based on updated risk assessment, without prior notice to the Creator.</p>
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">6.  Reserve Release</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">6.1  Rolling reserve amounts shall be released automatically upon expiry of the applicable holding period, subject to the following conditions being met:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">6.2  The applicable holding periods are 30 days, 60 days, and 90 days, as determined by the Creator’s risk classification in accordance with clause 5.2.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">6.3  Spenny Piggy reserves the right to reduce, extend, increase, or remove any reserve at any time based on updated risk assessment. Where risk persists beyond any stated holding period, reserved funds may be held for such further duration as Spenny Piggy considers necessary.</p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">7.  Chargebacks, Refunds and Offsets</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">7.1  Spenny Piggy reserves the right to deduct from a Creator’s available balance, earnings, or reserve funds any amounts arising from or in connection with:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">7.2  Where deductions result in a negative balance on a Creator’s account:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">7.3  The foregoing rights are without prejudice to any other recovery rights available to Spenny Piggy under the Terms of Service or applicable law.</p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">8.  Physical Goods (Wishlist and Storefront Purchases)</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">8.1  Where a Supporter purchases a physical item through the Platform, fulfilment of that item is handled by an independent third-party retailer via Spenny Piggy’s commerce infrastructure partners.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">8.2  The relevant retailer is solely responsible for:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">8.3  Spenny Piggy accepts no responsibility or liability in respect of:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">9.  Moderation and Payment Controls</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">9.1  Spenny Piggy operates an interconnected content and payment control framework. Where content or account activity gives rise to risk, Spenny Piggy may, without limitation:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">9.2  Such action may be taken where Spenny Piggy identifies, without limitation:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">10.  Account Restrictions</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">10.1  Spenny Piggy reserves the right to restrict, suspend, or terminate account features and access, at its sole discretion, where:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">11.  Risk Monitoring</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">11.1  Spenny Piggy operates a continuous risk monitoring framework. Risk signals assessed by Spenny Piggy may include, without limitation:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">11.2  Risk determinations are made by reference to the overall account profile and are not limited to any single signal or indicator. </p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">12.  Record Keeping and Audit</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">12.1  Spenny Piggy may retain records including, without limitation:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">12.2  Such records may be used for the purposes of compliance, audit, dispute resolution, and fulfilment of payment processor requirements.</p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">13.  Security and Account Integrity</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">13.1  Spenny Piggy may implement security controls including, without limitation:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">13.2  Where account compromise is suspected, Spenny Piggy may, at its sole discretion:</p>
                        ...
                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">14.  Payment Partner and Platform Protection</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">14.1  Spenny Piggy reserves the right to apply controls that exceed standard operational parameters where it considers such measures necessary to:</p>
                        ...
                        <p className="mb-4 text-gray-700 leading-relaxed">14.2  Spenny Piggy is not required to disclose its internal risk thresholds, scoring methodologies, or the specific basis for any individual risk determination.</p>

                        <h2 className="text-xl font-black text-gray-900 mt-10 mb-4">15.  Policy Updates</h2>
                        <p className="mb-4 text-gray-700 leading-relaxed">15.1  This Policy forms part of the Platform Legal Framework and is incorporated by reference into the Spenny Piggy Terms of Service. It may be updated at any time to reflect changes in fraud trends, legal or regulatory requirements, payment partner rules, or operational improvements.</p>
                        <p className="mb-4 text-gray-700 leading-relaxed">15.2  Continued use of the Platform following the publication of an updated Policy constitutes acceptance of the revised terms. Users are responsible for reviewing this Policy periodically.</p>
