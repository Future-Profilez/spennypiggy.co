            ...
            <LegalLayout activePage="UsAddendum">
                <div className="mx-auto w-full max-w-[92ch] px-5 py-10 sm:px-8 lg:px-12 lg:py-16">
                    ...
                    <div className="prose prose-pink max-w-none">
                        ...
                        <h2 id="sec-1-us-contracting-entity" className="text-xl font-black text-gray-900 mt-14 mb-4 scroll-mt-24">1. US Contracting Entity</h2>
                        ...
                        <h2 id="sec-2-arbitration-agreement-us-users-only" className="text-xl font-black text-gray-900 mt-14 mb-4 scroll-mt-24">2. Arbitration Agreement (US Users Only)</h2>
                        <p className="mb-5 text-gray-700 leading-relaxed italic">
                        ...
                        <h2 id="sec-3-class-action-waiver" className="text-xl font-black text-gray-900 mt-14 mb-4 scroll-mt-24">3. Class Action Waiver</h2>
                        <p className="mb-5 text-gray-700 leading-relaxed">
                        ...
                        <h2 id="sec-4-tax-compliance-irs-reporting" className="text-xl font-black text-gray-900 mt-14 mb-4 scroll-mt-24">4. Tax Compliance (IRS Reporting)</h2>
                        <p className="mb-5 text-gray-700 leading-relaxed">
                        ...
                        <h2 id="sec-5-state-specific-disclosures" className="text-xl font-black text-gray-900 mt-14 mb-4 scroll-mt-24">5. State-Specific Disclosures</h2>
                        <p className="mb-5 text-gray-700 leading-relaxed">
                        ...
                        <p className="text-sm text-black/60">© 2026 Social Vortex Limited / Social Vortex, Inc. All rights reserved.</p>
                    </div>
                </div>
            </LegalLayout>
        </Guest>
