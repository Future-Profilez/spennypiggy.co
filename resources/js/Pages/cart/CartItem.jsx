...
export default function CartItem({data, removeCart, quantityUpdate, currency}) {
    ...
    return (
        <div className={`fading border cartlist flex justify-between  content-between items-center border-black shadow-black rounded-[40px] 
            mb-3 mb-md-4 mb-ml-5 p-3 p-md-4`}>
            <div className='prodcartbox items-center'>
                <div className='productimg !rounded-[40px]  me-3'>
