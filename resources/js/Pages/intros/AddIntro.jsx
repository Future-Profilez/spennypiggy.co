      ...
      {intro ?
        <div className='relative'>
          ...
          <div className='relative'>
            ...
            <div
              className='isintro relative border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] !rounded-[20px] md:!rounded-[30px]  cursor-pointer overflow-hidden bg-[#f3f4f6]'
        ...
        { IsloggedIn ?
              <Popup modalclass="pinkmodal sendSurprize-modal shadow-[4px_4px_0px_0px_#FF007F]ink" space="6" size="md" action={close} classes={`${classes} w-full`}
                text={text ? text :
                  <div className='cursor-pointer bg-white border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] !rounded-[20px] md:!rounded-[30px]  p-3 py-4 flex items-center justify-content-center' >
                    <div className='py-6'>
