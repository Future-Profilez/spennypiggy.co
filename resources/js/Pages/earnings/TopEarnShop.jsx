  ...
  return (
    <section className="bg-white rounded-box p-5 md:p-6 border-[3px] border-black overflow-hidden h-full flex flex-col">
      <div className="pb-4 mb-4 flex items-center justify-between gap-3 border-b-2 border-black/10">
        <h2 className="font-gulfs uppercase tracking-[0.1em] text-[13px] text-black">Top Shop Items</h2>
      ...
      <div className="flex-grow">
        {loading ? (
          ...
          <div className="py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs font-black text-black/60 uppercase tracking-widest">No shop items found</p>
          </div>
        )}
      </div>
    </section>
