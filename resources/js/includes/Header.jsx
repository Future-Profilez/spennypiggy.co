        ...
        <div className='blackbg headermain py-14'>
            <div className='containerbox'>
                <div className='header flex w-full items-center content-center justify-between pinkbg border-mint shadow-mint'>
                    {auth?.user?.username ?
                        <Link href={`/${auth?.user?.username || ''}`} className='headtitle text-wh font-GillSans d-none d-lg-flex' > My Wishlist </Link>
                        :
...
=======
            <div className='cartLogin'>
            {auth && auth.stripe_details_submitted == 1 ? '' :
              <ChangeCurrency defaultvalue={global_currency} changer={true} />
             }
...
>>>>>>> 7c6ae992a0f5199e0e5b1cb7c6c98b5e91cfb86c
        </div>
                    ...
                    <ul>
                        {auth?.user?.username || false ?
                            <>
                                ...
                                <li><Link onClick={toggleClass} href={`/${auth && auth?.user?.username || ''}`} >My Wishlist</Link></li>
                                <li><Link onClick={toggleClass} href={`/wish-tracker`} >Wish Tracker</Link></li>
                            </>
                            :
                            <>
                                <li><Link onClick={toggleClass} href="/register" >Create Wishlist</Link></li>
