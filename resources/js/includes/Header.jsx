      ...
      <div className='containerbox'>
        <div className='header flex w-full items-center content-center justify-between pinkbg border-mint shadow-mint'>
          ...
          <div className='cartLogin'>
            <Link href={route('cart')} className='cartLink'>
            ...
            {loggedIn ?
                <Link method="get" href={route('logout')} as="button" className='btn-mint mx-3'>Logout</Link>
                :
                <Link href={route("login")} className='btn-mint mx-3'>Login</Link>
            }
          ...
          <button className="closemega" onClick={toggleClass}>
            <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul>
                ...
                <li><Link to="/">Create Wishlist</Link></li> 
