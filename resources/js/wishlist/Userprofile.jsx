  ...
  return (
    <div className='userprofilesec rounded-3xl whbg'>
      ...
      <div className='px-3' >
        ...
        <div className='userId flex items-center justify-center'>@{user && user.username} <Link to="/" className='ms-4'><svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
        ...
        <p className='text-muted text-center' >{user && user.bio || "lorem  we875r8wfsdbfh w87r8w erweg"}</p>
      </div>
    </div>
  )
}
