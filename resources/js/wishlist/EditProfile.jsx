...
export default function EditProfile() {
  return (
    <Popup text={<><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <div className='editForm'>
            <form>
              <ul>
                ...
                <li className="mb-3">
                  <label className="mb-1">Wishlist URL</label>
                  <input type="text" name="WishName" class="form-input px-2 py-2 border w-full rounded-md" placeholder='Spennypiggy.com/warner99' />
                </li>
                <li className="mb-3">
              ...
              <div className=" text-center mb-7">
                <button className="editProfile flex w-12 mx-auto">Add Wish</button>
              </div>
            </form>
          </div>
