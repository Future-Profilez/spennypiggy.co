                ...
                <form onSubmit={submit} className="p-8 md:p-10 relative z-10 max-h-[70vh] overflow-auto custom-scrollbar">
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <button 
                            type="button" 
                            onClick={onClose}
                            className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 border border-white/20 text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-300"
                        >
