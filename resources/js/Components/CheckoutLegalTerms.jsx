        ...
        <div className="checkout-legal-terms text-left w-full mt-4 !pb-4 ">
            <label className="flex items-start cursor-pointer mb-3 min-h-[44px] py-1">
                ...
                <span className="!text-start text-normal font-medium text-black leading-tight pt-1">
                    I agree to the <Link target="_blank" className="text-[#FF007F] hover:underline" href={route("terms-and-conditions")}>Terms of Service</Link> and <Link target="_blank" className="text-[#FF007F] hover:underline" href={route("terms-and-conditions")}>Privacy Policy</Link>.
                </span>
            </label>

            <div className="pl-9 pr-2 ">
                <p className="text-sm text-black/80 font-semibold mb-2">By continuing, I confirm that:</p>
                ...
                {expanded && (
                    <div className="mt-3 mb-4 p-4 bg-black/[0.03] rounded-box-sm border border-black/10">
                        <p className="text-sm text-black/80 font-semibold mb-2">By completing this purchase, I acknowledge and agree that:</p>
