    ...
    const memoizedTabs = useMemo(() => {
        ...
        tabContent.about = (
            <div className="tab-content-about">
                {user?.bio ? (
                    <div className="bg-white rounded-[40px]   p-4 shadow-sm mb-4">
                        <h3 className="font-semibold text-lg mb-2">About</h3>
                        <p className="text-gray-700 leading-relaxed">{user.bio}</p>
                    </div>
                ) : (
                    <div className="bg-gray-50 rounded-[40px]   p-6 text-center mb-4">
                ...
                {posts && posts.length > 0 && (
                    <div className="bg-white rounded-[40px]   p-4 shadow-sm mt-4">
