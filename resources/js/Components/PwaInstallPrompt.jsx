  ...
  if (showChromeHelp) {
    return (
      <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center bg-black/40">
        <div className="w-full sm:max-w-md sm:rounded-[40px]   sm:shadow-xl sm:mx-auto bg-white  border-t sm:border border-neutral-200 ">
          <div className="p-4 sm:p-6">
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                className="px-6 py-2 rounded-[40px]  bg-pink-600 hover:bg-pink-700 text-white font-medium"
              >
                Got it! 🐷
              </button>
            </div>
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="mt-4 flex gap-3 justify-center">
            <button
              type="button"
              onClick={handleDismiss}
              className="px-4 py-2 rounded-[40px]  border border-neutral-300   text-neutral-700  bg-white   hover:bg-neutral-50  "
            >
              Not now
            </button>
            ...
            {isChromium ? (
              <button
                ...
                className="px-4 py-2 rounded-[40px]  bg-pink-600 hover:bg-pink-700 text-white font-medium"
              >
                Install
              </button>
            ) : (
