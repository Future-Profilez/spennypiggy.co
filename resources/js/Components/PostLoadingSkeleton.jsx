...
export default function PostLoadingSkeleton({ count = 3 }) {
    const skeletonItems = Array.from({ length: count }, (_, index) => (
        <div key={index} className="post-wrap bg-gray-100 bg-light rounded-[30px]  md:rounded-[30px]  p-[15px] xl:p-6 mb-3 mb-md-4 ">
            {/* Header */}
            ...
            {/* Image skeleton */}
            <div className="animate-flash w-full h-64 bg-gray-300 rounded-[30px]  md:rounded-[30px]  mb-3"></div>
