        ...
        {sLinks && sLinks.length > 0 && (
            <>
                ...
                <div className="space-y-6">
                    <div className="bg-white/5 backdrop-blur-2xl border border-white/5 rounded-[30px]  p-8 shadow-[4px_4px_0px_0px_#FF007F]xl transition-all hover:border-white/10 group">
                        ...
                        <div className="flex flex-col gap-4">
                            {sLinks.map((link, index) => (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-between p-5 bg-white/5 rounded-[30px]  border border-white/5 text-white/70 hover:bg-white/10 hover:text-white transition-all group/link"
                                >
