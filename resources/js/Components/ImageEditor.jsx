...
const ImageEditor = ({ image, onSave, className = '' }) => {
    return (
        <div className={`image-editor-container ${className}`}>
            <div className="bg-white p-6 rounded-box ">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Image Editor</h3>
                <div className="border-2 border-dashed border-gray-300 rounded-box    p-8 text-center">
                    {image ? (
                        <img 
                            src={image} 
                            alt="Editor preview" 
                        ...
                        <div className="text-black/60">
                            <svg className="mx-auto h-12 w-12 text-black/60" stroke="currentColor" fill="none" viewBox="0 0 48 48">
