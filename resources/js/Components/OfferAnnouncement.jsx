...
export default function OfferAnnouncement({ 
    ...
    return <>
    <div className="my-2 mb-4 block w-full relative overflow-hidden bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-[30px] md:rounded-[40px]  shadow-lg p-6 text-white">
            <button
