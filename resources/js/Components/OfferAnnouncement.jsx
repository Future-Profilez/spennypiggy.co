...
export default function OfferAnnouncement({ 
    ...
    <div className="my-2 mb-4 block w-full relative overflow-hidden bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-[30px] md:rounded-[40px]   p-6 text-white bg-[#ff6b6b] border-[3px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
            <button
