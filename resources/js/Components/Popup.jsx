...
export default function Popup(props) {
  ...
  return <>
      ...
      centered className={`${modalclass} mymodal `} >
      <Modal.Body className={`p-0 ${bodyclass} `} >
        {!hidecontrols ?
