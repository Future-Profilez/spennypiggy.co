...
export const MemoizedButton = memo(({ 
    ...
    const baseClasses = 'inline-flex items-center justify-center rounded-[30px] md:rounded-[40px]  font-medium focus:outline-none focus:ring-2 focus:ring-offset-2';
...
export const VirtualizedList = memo(({ 
    ...
    return (
        <div 
            className="overflow-auto border border-gray-200 rounded-[30px] md:rounded-[40px]  "
...
export const OptimizedCard = memo(({ 
    ...
    const cardContent = useMemo(() => (
        <div className={`bg-white overflow-hidden shadow-sm rounded-[30px] md:rounded-[40px]   ${className}`}>
            {image && (
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={`inline-block align-bottom bg-white rounded-[30px] md:rounded-[40px]   text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle ${sizeClasses[size]} w-full`}>
    ...
    render() {
        if (this.state.hasError) {
            return this.props.fallback || (
                <div className="p-4 border border-red-200 rounded-[30px] md:rounded-[40px]   bg-red-50">
