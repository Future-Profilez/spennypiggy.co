    ...
    <>
      ...
      <div className="min-h-screen md:py-12 overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#FF007F] via-[#EFEA7B] to-white p-6">
         <div className="max-w-2xl w-full bg-[#fff] md:bg-white rounded-[30px]   md:rounded-[30px]   shadow-[4px_4px_0px_0px_#FF007F]l p-6 sm:p-8 md:p-12 text-center relative">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#FF007F]/10 mb-4 mx-auto relative">
                  <div className="absolute inset-0 rounded-full bg-[#FF007F]/20 animate-ping" />
                  <span className="relative text-4xl animate-bounce">🐷</span>
            </div>
            <p className="uppercase tracking-[0.25em] text-xs text-[#FF007F] font-semibold mb-2">
                  live update in progress
            </p>
            <h1 className="text-xl md:text-3xl font-gulfs text-[#FF007F] mb-3 tracking-wide uppercase">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-3">
                  ...
                  <a
                     href="/"
                     className="px-6 py-2.5 rounded-full border border-[#FF007F] text-[#FF007F] font-semibold hover:bg-[#FF007F]/5 transition"
                  >
                     Go to homepage
                  </a>
            </div>
