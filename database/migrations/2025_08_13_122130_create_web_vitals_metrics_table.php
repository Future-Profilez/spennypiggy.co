...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('web_vitals_metrics', function (Blueprint $table) {
            $table->id();
            $table->string('metric_name')->index(); // LCP, FID, CLS, FCP, TTFB, INP
            ...
            $table->string('url', 500)->index(); // Page URL
            $table->text('user_agent')->nullable();
            $table->string('connection_type', 50)->nullable()->index(); // Network connection type
            ...
            $table->index('created_at'); // Separate index for time-based queries
        });
    }
