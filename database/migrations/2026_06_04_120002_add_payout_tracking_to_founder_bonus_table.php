...
return new class extends Migration
{
    ...
    {
        Schema::table('founder_bonus', function (Blueprint $table) {
            $table->dropIndex('founder_bonus_stripe_payout_id_index');
            $table->dropIndex('founder_bonus_payout_record_uuid_index');
            $table->dropColumn(['stripe_transfer_id', 'stripe_payout_id', 'payout_record_uuid']);
        });
    }
};
