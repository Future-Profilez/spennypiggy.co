...
const SocialLinks = React.lazy(() => import("./SocialLinks-6a108ce6.js"));
const ShareProfile = React.lazy(() => import("./ShareProfile-d3c3ccb4.js"));
const SendSurprise = React.lazy(() => import("./SendSurprise-cd1038d0.js"));
function Userprofile({ auth, user, links, IsloggedIn }) {
  return /* @__PURE__ */ jsxs("div", { className: "userprofilesec rounded-3xl whbg", children: [
    /* @__PURE__ */ jsx("div", { className: "userphotobox pinkbg pink-shadow flex justify-center relative", children: /* @__PURE__ */ jsx(
      "img",
      {
        className: "d-lg-none",
        src: user && (user == null ? void 0 : user.cover_url) || wishlistbannerimg,
        alt: "img"
      }
    ) }),
    /* @__PURE__ */ jsxs("div", { className: "userPr p-4", children: [
      /* @__PURE__ */ jsx("div", { className: "userphoto", children: /* @__PURE__ */ jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsx("h2", { className: "font-GillSans", children: user && user.name }),
      /* @__PURE__ */ jsx("div", { className: "userId flex items-center justify-center", children: /* @__PURE__ */ jsxs(
        ShareProfile,
        {
          ...
          children: [
            "@",
            user && user.username,
            /* @__PURE__ */ jsx("div", { className: "mt-1 ms-2", children: /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "19", height: "18", viewBox: "0 0 19 18", fill: "none", children: [
              " ",
      ...
      /* @__PURE__ */ jsx(SocialLinks, { links }),
      !IsloggedIn ? /* @__PURE__ */ jsx(SendSurprise, { auth, owner: user }) : "",
      /* @__PURE__ */ jsx("p", { className: `text-muted text-center mt-3 ${user && !user.bio ? "d-none" : ""}`, children: user && user.bio || "" })
    ] })
  ] });
}
export {
