import{j as i}from"./jsx-runtime-BJoFowxM.js";import{X as r,r as n,a as s}from"../ssr.mjs";import"util";import"stream";import"path";import"http";import"https";import"url";import"fs";import"crypto";import"http2";import"assert";import"tty";import"os";import"zlib";import"events";import"process";try{let t=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},a=new t.Error().stack;a&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[a]="3e4b0335-5900-4eda-98ae-5cf1b90efc01",t._sentryDebugIdIdentifier="sentry-dbid-3e4b0335-5900-4eda-98ae-5cf1b90efc01")}catch{}function _(){const{ziggy:t}=r().props,[a,o]=n.useState("");return n.useEffect(()=>{(async()=>{try{await s.get("https://ipapi.co/json/").then(e=>{t&&t.url==="https://spennypiggy.co"&&e.data&&e.data.country_code=="GB"&&(o("https://uk.spennypiggy.co"),setTimeout(()=>{window.location="https://uk.spennypiggy.co/register"},3e3)),t&&t.url==="https://uk.spennypiggy.co"&&e.data&&e.data.country_code!=="GB"&&(o("https://spennypiggy.co"),setTimeout(()=>{window.location="https://spennypiggy.co/register"},3e3))}).catch(e=>{console.error("api err",e)})}catch(e){console.error("Error fetching data:",e)}})()},[]),i.jsxs(i.Fragment,{children:[i.jsx("style",{children:`
